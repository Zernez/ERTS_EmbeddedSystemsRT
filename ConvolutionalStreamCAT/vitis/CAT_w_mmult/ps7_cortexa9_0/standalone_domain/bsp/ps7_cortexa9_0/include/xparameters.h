...
/* Definitions for driver MMULT */
#define XPAR_XMMULT_NUM_INSTANCES 1

/* Definitions for peripheral MMULT_0 */
#define XPAR_MMULT_0_DEVICE_ID 0
#define XPAR_MMULT_0_S_AXI_CONTROL_BASEADDR 0x40000000
#define XPAR_MMULT_0_S_AXI_CONTROL_HIGHADDR 0x4000FFFF


/******************************************************************/

/* Canonical definitions for peripheral MMULT_0 */
#define XPAR_XMMULT_0_DEVICE_ID XPAR_MMULT_0_DEVICE_ID
#define XPAR_XMMULT_0_S_AXI_CONTROL_BASEADDR 0x40000000
#define XPAR_XMMULT_0_S_AXI_CONTROL_HIGHADDR 0x4000FFFF
