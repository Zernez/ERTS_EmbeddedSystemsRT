...
set C_modelArgList {
	...
	{ b_buffer int 32 regular {array 64 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "B_port", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "B","offset": { "type": "dynamic","port_name": "B","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "b_buffer", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ b_buffer_address0 sc_out sc_lv 6 signal 2 } 
	{ b_buffer_ce0 sc_out sc_logic 1 signal 2 } 
	{ b_buffer_we0 sc_out sc_logic 1 signal 2 } 
	{ b_buffer_d0 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "b_buffer_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "b_buffer", "role": "we0" }} , 
 	{ "name": "b_buffer_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "b_buffer", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	b_buffer { ap_memory {  { b_buffer_address0 mem_address 1 6 }  { b_buffer_ce0 mem_ce 1 1 }  { b_buffer_we0 mem_we 1 1 }  { b_buffer_d0 mem_din 1 32 } } }
}
