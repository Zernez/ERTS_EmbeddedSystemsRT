...
set C_modelArgList {
	...
	{ a_buffer int 32 regular {array 64 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "A_port", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "A","offset": { "type": "dynamic","port_name": "A","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "a_buffer", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ m_axi_A_port_AWLEN sc_out sc_lv 32 signal 0 } 
	...
	{ m_axi_A_port_ARLEN sc_out sc_lv 32 signal 0 } 
	...
	{ m_axi_A_port_RFIFONUM sc_in sc_lv 9 signal 0 } 
	...
	{ a_buffer_address0 sc_out sc_lv 6 signal 2 } 
	{ a_buffer_ce0 sc_out sc_logic 1 signal 2 } 
	{ a_buffer_we0 sc_out sc_logic 1 signal 2 } 
	{ a_buffer_d0 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "m_axi_A_port_AWLEN", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "A_port", "role": "AWLEN" }} , 
 	...
 	{ "name": "m_axi_A_port_ARLEN", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "A_port", "role": "ARLEN" }} , 
 	...
 	{ "name": "m_axi_A_port_RFIFONUM", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "A_port", "role": "RFIFONUM" }} , 
 	...
 	{ "name": "a_buffer_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "a_buffer", "role": "we0" }} , 
 	{ "name": "a_buffer_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "a_buffer", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	 { m_axi {  { m_axi_A_port_AWVALID VALID 1 1 }  { m_axi_A_port_AWREADY READY 0 1 }  { m_axi_A_port_AWADDR ADDR 1 64 }  { m_axi_A_port_AWID ID 1 1 }  { m_axi_A_port_AWLEN SIZE 1 32 }  { m_axi_A_port_AWSIZE BURST 1 3 }  { m_axi_A_port_AWBURST LOCK 1 2 }  { m_axi_A_port_AWLOCK CACHE 1 2 }  { m_axi_A_port_AWCACHE PROT 1 4 }  { m_axi_A_port_AWPROT QOS 1 3 }  { m_axi_A_port_AWQOS REGION 1 4 }  { m_axi_A_port_AWREGION USER 1 4 }  { m_axi_A_port_AWUSER DATA 1 1 }  { m_axi_A_port_WVALID VALID 1 1 }  { m_axi_A_port_WREADY READY 0 1 }  { m_axi_A_port_WDATA FIFONUM 1 32 }  { m_axi_A_port_WSTRB STRB 1 4 }  { m_axi_A_port_WLAST LAST 1 1 }  { m_axi_A_port_WID ID 1 1 }  { m_axi_A_port_WUSER DATA 1 1 }  { m_axi_A_port_ARVALID VALID 1 1 }  { m_axi_A_port_ARREADY READY 0 1 }  { m_axi_A_port_ARADDR ADDR 1 64 }  { m_axi_A_port_ARID ID 1 1 }  { m_axi_A_port_ARLEN SIZE 1 32 }  { m_axi_A_port_ARSIZE BURST 1 3 }  { m_axi_A_port_ARBURST LOCK 1 2 }  { m_axi_A_port_ARLOCK CACHE 1 2 }  { m_axi_A_port_ARCACHE PROT 1 4 }  { m_axi_A_port_ARPROT QOS 1 3 }  { m_axi_A_port_ARQOS REGION 1 4 }  { m_axi_A_port_ARREGION USER 1 4 }  { m_axi_A_port_ARUSER DATA 1 1 }  { m_axi_A_port_RVALID VALID 0 1 }  { m_axi_A_port_RREADY READY 1 1 }  { m_axi_A_port_RDATA FIFONUM 0 32 }  { m_axi_A_port_RLAST LAST 0 1 }  { m_axi_A_port_RID ID 0 1 }  { m_axi_A_port_RFIFONUM LEN 0 9 }  { m_axi_A_port_RUSER DATA 0 1 }  { m_axi_A_port_RRESP RESP 0 2 }  { m_axi_A_port_BVALID VALID 0 1 }  { m_axi_A_port_BREADY READY 1 1 }  { m_axi_A_port_BRESP RESP 0 2 }  { m_axi_A_port_BID ID 0 1 }  { m_axi_A_port_BUSER DATA 0 1 } } }
	sext_ln19 { ap_none {  { sext_ln19 in_data 0 62 } } }
	a_buffer { ap_memory {  { a_buffer_address0 mem_address 1 6 }  { a_buffer_ce0 mem_ce 1 1 }  { a_buffer_we0 mem_we 1 1 }  { a_buffer_d0 mem_din 1 32 } } }
}
