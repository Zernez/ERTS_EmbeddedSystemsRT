...
reg   [0:0] exitcond249_reg_129;
reg    ap_block_state2_pp0_stage0_iter1;
wire    ap_block_state3_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_subdone;
wire   [0:0] exitcond249_fu_86_p2;
...
wire   [5:0] empty_22_fu_98_p1;
reg   [5:0] empty_22_reg_133;
reg   [5:0] empty_22_reg_133_pp0_iter1_reg;
reg   [31:0] B_port_addr_read_reg_138;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] tmp_1_cast_fu_113_p1;
reg   [6:0] loop_index10_fu_46;
wire   [6:0] empty_21_fu_92_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (exitcond249_fu_86_p2 == 1'd0))) begin
            loop_index10_fu_46 <= empty_21_fu_92_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index10_fu_46 <= 7'd0;
        end
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond249_reg_129 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond249_fu_86_p2 == 1'd0))) begin
        empty_22_reg_133 <= empty_22_fu_98_p1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (exitcond249_reg_129 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond249_fu_86_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (exitcond249_reg_129 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond249_reg_129 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((exitcond249_reg_129 == 1'd0) & (m_axi_B_port_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((exitcond249_reg_129 == 1'd0) & (m_axi_B_port_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((exitcond249_reg_129 == 1'd0) & (m_axi_B_port_RVALID == 1'b0));
end
...
assign b_buffer_address0 = tmp_1_cast_fu_113_p1;

assign b_buffer_d0 = B_port_addr_read_reg_138;

assign empty_21_fu_92_p2 = (ap_sig_allocacmp_loop_index10_load + 7'd1);

assign empty_22_fu_98_p1 = ap_sig_allocacmp_loop_index10_load[5:0];

assign exitcond249_fu_86_p2 = ((ap_sig_allocacmp_loop_index10_load == 7'd64) ? 1'b1 : 1'b0);
...
assign tmp_1_cast_fu_113_p1 = empty_22_reg_133_pp0_iter1_reg;
