...
reg   [0:0] exitcond5_reg_134;
reg   [31:0] c_buffer_load_reg_148;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] tmp_27_cast_fu_107_p1;
wire    ap_block_pp0_stage0_01001;
reg   [6:0] loop_index_fu_48;
wire   [6:0] empty_19_fu_97_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_loop_index_load;
wire   [5:0] empty_20_fu_103_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond5_fu_91_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index_fu_48 <= empty_19_fu_97_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index_fu_48 <= 7'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond5_reg_134 == 1'd0))) begin
...
always @ (*) begin
    if (((exitcond5_fu_91_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond5_reg_134 == 1'd1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_C_port_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_C_port_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end
...
assign c_buffer_address0 = tmp_27_cast_fu_107_p1;

assign empty_19_fu_97_p2 = (ap_sig_allocacmp_loop_index_load + 7'd1);

assign empty_20_fu_103_p1 = ap_sig_allocacmp_loop_index_load[5:0];

assign exitcond5_fu_91_p2 = ((ap_sig_allocacmp_loop_index_load == 7'd64) ? 1'b1 : 1'b0);
...
assign m_axi_C_port_WDATA = c_buffer_load_reg_148;
...
assign tmp_27_cast_fu_107_p1 = empty_20_fu_103_p1;
