; ModuleID = 'C:/Users/User/Desktop/UNI/EmbeddedRealTimeSystem/Assignment2/HLS_labs/lab2/yuv_filter.prj/solution2/.autopilot/db/a.o.3.bc'
...
.reset:                                           ; preds = %1
  ...
  %tmp_10_cast = zext i23 %tmp_5 to i32, !dbg !98 ; [#uses=6 type=i32] [debug line = 134:2]
  %in_channels_ch1_addr = getelementptr [2457600 x i8]* %in_channels_ch1, i32 0, i32 %tmp_10_cast, !dbg !98 ; [#uses=1 type=i8*] [debug line = 134:2]
  %in_channels_ch2_addr = getelementptr [2457600 x i8]* %in_channels_ch2, i32 0, i32 %tmp_10_cast, !dbg !101 ; [#uses=1 type=i8*] [debug line = 135:10]
  %in_channels_ch3_addr = getelementptr [2457600 x i8]* %in_channels_ch3, i32 0, i32 %tmp_10_cast, !dbg !102 ; [#uses=1 type=i8*] [debug line = 136:10]
  %out_channels_ch1_add = getelementptr [2457600 x i8]* %out_channels_ch1, i32 0, i32 %tmp_10_cast, !dbg !103 ; [#uses=1 type=i8*] [debug line = 140:10]
  %out_channels_ch2_add = getelementptr [2457600 x i8]* %out_channels_ch2, i32 0, i32 %tmp_10_cast, !dbg !104 ; [#uses=1 type=i8*] [debug line = 141:10]
  %out_channels_ch3_add = getelementptr [2457600 x i8]* %out_channels_ch3, i32 0, i32 %tmp_10_cast, !dbg !105 ; [#uses=1 type=i8*] [debug line = 142:10]
...
; <label>:1                                       ; preds = %.reset, %0
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !247 ; [debug line = 90:1]
  call void @llvm.dbg.value(metadata !{i16 %x_2}, i64 0, metadata !249), !dbg !250 ; [debug line = 89:23] [debug variable = x]
  %exitcond_flatten = icmp eq i32 %indvar_flatten, %bound ; [#uses=1 type=i1]
  %indvar_flatten_next = add i32 %indvar_flatten, 1 ; [#uses=1 type=i32]
  br i1 %exitcond_flatten, label %2, label %.reset

.reset:                                           ; preds = %1
  %x_2 = add i16 1, %x, !dbg !250                 ; [#uses=1 type=i16] [debug line = 89:23]
  call void @llvm.dbg.value(metadata !{i16 %x_2}, i64 0, metadata !249), !dbg !250 ; [debug line = 89:23] [debug variable = x]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !247 ; [debug line = 90:1]
  call void (...)* @_ssdm_op_SpecLoopName([30 x i8]* @YUV2RGB_LOOP_X_YUV2R)
  call void (...)* @_ssdm_op_SpecLoopTripCount(i64 40000, i64 2457600, i64 784400)
  %exitcond5 = icmp eq i16 %y, %in_height_read_2, !dbg !251 ; [#uses=2 type=i1] [debug line = 92:12]
  %y_mid2 = select i1 %exitcond5, i16 0, i16 %y   ; [#uses=2 type=i16]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !247 ; [debug line = 90:1]
  %tmp_mid2_v = select i1 %exitcond5, i16 %x_2, i16 %x, !dbg !253 ; [#uses=3 type=i16] [debug line = 94:2]
  ...
  %p_shl3_cast = call i23 @_ssdm_op_BitConcatenate.i23.i15.i8(i15 %tmp_2, i8 0), !dbg !253 ; [#uses=1 type=i23] [debug line = 94:2]
  %tmp_s = add i23 %p_shl3_cast, %p_shl2_cast, !dbg !253 ; [#uses=1 type=i23] [debug line = 94:2]
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @p_str4) nounwind, !dbg !255 ; [debug line = 92:33]
  %tmp_cast = zext i16 %y_mid2 to i23, !dbg !253  ; [#uses=1 type=i23] [debug line = 94:2]
  %tmp_8 = add i23 %tmp_s, %tmp_cast, !dbg !253   ; [#uses=1 type=i23] [debug line = 94:2]
  %tmp_28_cast = zext i23 %tmp_8 to i32, !dbg !253 ; [#uses=6 type=i32] [debug line = 94:2]
  %in_channels_ch1_addr = getelementptr [2457600 x i8]* %in_channels_ch1, i32 0, i32 %tmp_28_cast, !dbg !253 ; [#uses=1 type=i8*] [debug line = 94:2]
  %in_channels_ch2_addr = getelementptr [2457600 x i8]* %in_channels_ch2, i32 0, i32 %tmp_28_cast, !dbg !256 ; [#uses=1 type=i8*] [debug line = 95:10]
  %in_channels_ch3_addr = getelementptr [2457600 x i8]* %in_channels_ch3, i32 0, i32 %tmp_28_cast, !dbg !257 ; [#uses=1 type=i8*] [debug line = 96:10]
  %out_channels_ch1_add = getelementptr [2457600 x i8]* %out_channels_ch1, i32 0, i32 %tmp_28_cast, !dbg !258 ; [#uses=1 type=i8*] [debug line = 103:10]
  %out_channels_ch2_add = getelementptr [2457600 x i8]* %out_channels_ch2, i32 0, i32 %tmp_28_cast, !dbg !259 ; [#uses=1 type=i8*] [debug line = 104:10]
  %out_channels_ch3_add = getelementptr [2457600 x i8]* %out_channels_ch3, i32 0, i32 %tmp_28_cast, !dbg !260 ; [#uses=1 type=i8*] [debug line = 105:10]
  %Y = load i8* %in_channels_ch1_addr, align 1, !dbg !253 ; [#uses=1 type=i8] [debug line = 94:2]
  call void @llvm.dbg.value(metadata !{i8 %Y}, i64 0, metadata !261), !dbg !253 ; [debug line = 94:2] [debug variable = Y]
  ...
  %y_2 = add i16 1, %y_mid2, !dbg !278            ; [#uses=1 type=i16] [debug line = 92:27]
  call void @llvm.dbg.value(metadata !{i16 %y_2}, i64 0, metadata !279), !dbg !278 ; [debug line = 92:27] [debug variable = y]
...
; <label>:2                                       ; preds = %1
  ...
  %mrv = insertvalue { i16, i16 } undef, i16 %in_width_read_2, 0, !dbg !280 ; [#uses=1 type={ i16, i16 }] [debug line = 108:1]
  %mrv_1 = insertvalue { i16, i16 } %mrv, i16 %in_height_read_2, 1, !dbg !280 ; [#uses=1 type={ i16, i16 }] [debug line = 108:1]
  ret { i16, i16 } %mrv_1, !dbg !280              ; [debug line = 108:1]
}
...
define internal fastcc { i16, i16 } @rgb2yuv([2457600 x i8]* nocapture %in_channels_ch1, [2457600 x i8]* nocapture %in_channels_ch2, [2457600 x i8]* nocapture %in_channels_ch3, i16 %in_width_read, i16 %in_height_read, [2457600 x i8]* nocapture %out_channels_ch1, [2457600 x i8]* nocapture %out_channels_ch2, [2457600 x i8]* nocapture %out_channels_ch3) {
  ...
  call void @llvm.dbg.value(metadata !{i16 %in_height_read11}, i64 0, metadata !281), !dbg !284 ; [debug line = 30:16] [debug variable = in.height]
  call void @llvm.dbg.value(metadata !{i16 %in_height_read11}, i64 0, metadata !285), !dbg !287 ; [debug line = 31:16] [debug variable = out.height]
  %in_width_read_3 = call i16 @_ssdm_op_Read.ap_auto.i16(i16 %in_width_read) ; [#uses=2 type=i16]
  call void @llvm.dbg.value(metadata !{i16 %in_width_read_3}, i64 0, metadata !288), !dbg !284 ; [debug line = 30:16] [debug variable = in.width]
  call void @llvm.dbg.value(metadata !{i16 %in_width_read_3}, i64 0, metadata !289), !dbg !287 ; [debug line = 31:16] [debug variable = out.width]
  call void @llvm.dbg.value(metadata !{[2457600 x i8]* %in_channels_ch1}, i64 0, metadata !290), !dbg !284 ; [debug line = 30:16] [debug variable = in.channels.ch1]
  call void @llvm.dbg.value(metadata !{[2457600 x i8]* %in_channels_ch2}, i64 0, metadata !291), !dbg !284 ; [debug line = 30:16] [debug variable = in.channels.ch2]
  call void @llvm.dbg.value(metadata !{[2457600 x i8]* %in_channels_ch3}, i64 0, metadata !292), !dbg !284 ; [debug line = 30:16] [debug variable = in.channels.ch3]
  call void @llvm.dbg.value(metadata !{i16 %in_width_read}, i64 0, metadata !288), !dbg !284 ; [debug line = 30:16] [debug variable = in.width]
  call void @llvm.dbg.value(metadata !{i16 %in_height_read}, i64 0, metadata !281), !dbg !284 ; [debug line = 30:16] [debug variable = in.height]
  call void @llvm.dbg.value(metadata !{[2457600 x i8]* %out_channels_ch1}, i64 0, metadata !293), !dbg !287 ; [debug line = 31:16] [debug variable = out.channels.ch1]
  call void @llvm.dbg.value(metadata !{[2457600 x i8]* %out_channels_ch2}, i64 0, metadata !294), !dbg !287 ; [debug line = 31:16] [debug variable = out.channels.ch2]
  call void @llvm.dbg.value(metadata !{[2457600 x i8]* %out_channels_ch3}, i64 0, metadata !295), !dbg !287 ; [debug line = 31:16] [debug variable = out.channels.ch3]
  call void @llvm.dbg.value(metadata !{i16 %in_width_read}, i64 0, metadata !296), !dbg !298 ; [debug line = 43:4] [debug variable = width]
  call void @llvm.dbg.value(metadata !{i16 %in_height_read}, i64 0, metadata !299), !dbg !300 ; [debug line = 44:4] [debug variable = height]
  %cast = zext i16 %in_width_read_3 to i32        ; [#uses=1 type=i32]
  %cast1 = zext i16 %in_height_read11 to i32      ; [#uses=1 type=i32]
  %bound = mul i32 %cast1, %cast                  ; [#uses=1 type=i32]
  br label %1, !dbg !301                          ; [debug line = 49:9]

; <label>:1                                       ; preds = %.reset, %0
  %indvar_flatten = phi i32 [ 0, %0 ], [ %indvar_flatten_next, %.reset ] ; [#uses=2 type=i32]
  %x = phi i16 [ 0, %0 ], [ %tmp_mid2_v, %.reset ] ; [#uses=2 type=i16]
  %y = phi i16 [ 0, %0 ], [ %y_3, %.reset ]       ; [#uses=2 type=i16]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !303 ; [debug line = 50:1]
  call void @llvm.dbg.value(metadata !{i16 %x_3}, i64 0, metadata !305), !dbg !306 ; [debug line = 49:23] [debug variable = x]
  %exitcond_flatten = icmp eq i32 %indvar_flatten, %bound ; [#uses=1 type=i1]
  %indvar_flatten_next = add i32 %indvar_flatten, 1 ; [#uses=1 type=i32]
  br i1 %exitcond_flatten, label %2, label %.reset

.reset:                                           ; preds = %1
  %x_3 = add i16 1, %x, !dbg !306                 ; [#uses=1 type=i16] [debug line = 49:23]
  call void @llvm.dbg.value(metadata !{i16 %x_3}, i64 0, metadata !305), !dbg !306 ; [debug line = 49:23] [debug variable = x]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !303 ; [debug line = 50:1]
  call void (...)* @_ssdm_op_SpecLoopName([30 x i8]* @RGB2YUV_LOOP_X_RGB2Y)
  call void (...)* @_ssdm_op_SpecLoopTripCount(i64 40000, i64 2457600, i64 784400)
  %exitcond9 = icmp eq i16 %y, %in_height_read11, !dbg !307 ; [#uses=2 type=i1] [debug line = 52:12]
  ...
  %tmp_19 = add i23 %tmp_cast, %tmp_s, !dbg !309  ; [#uses=1 type=i23] [debug line = 54:2]
  %tmp_42_cast = zext i23 %tmp_19 to i32, !dbg !309 ; [#uses=6 type=i32] [debug line = 54:2]
  %in_channels_ch1_addr = getelementptr [2457600 x i8]* %in_channels_ch1, i32 0, i32 %tmp_42_cast, !dbg !309 ; [#uses=1 type=i8*] [debug line = 54:2]
  %in_channels_ch2_addr = getelementptr [2457600 x i8]* %in_channels_ch2, i32 0, i32 %tmp_42_cast, !dbg !312 ; [#uses=1 type=i8*] [debug line = 55:10]
  %in_channels_ch3_addr = getelementptr [2457600 x i8]* %in_channels_ch3, i32 0, i32 %tmp_42_cast, !dbg !313 ; [#uses=1 type=i8*] [debug line = 56:10]
  %out_channels_ch1_add = getelementptr [2457600 x i8]* %out_channels_ch1, i32 0, i32 %tmp_42_cast, !dbg !314 ; [#uses=1 type=i8*] [debug line = 60:10]
  %out_channels_ch2_add = getelementptr [2457600 x i8]* %out_channels_ch2, i32 0, i32 %tmp_42_cast, !dbg !315 ; [#uses=1 type=i8*] [debug line = 61:10]
  %out_channels_ch3_add = getelementptr [2457600 x i8]* %out_channels_ch3, i32 0, i32 %tmp_42_cast, !dbg !316 ; [#uses=1 type=i8*] [debug line = 62:10]
  %R = load i8* %in_channels_ch1_addr, align 1, !dbg !309 ; [#uses=4 type=i8] [debug line = 54:2]
  call void @llvm.dbg.value(metadata !{i8 %R}, i64 0, metadata !317), !dbg !309 ; [debug line = 54:2] [debug variable = R]
  %G = load i8* %in_channels_ch2_addr, align 1, !dbg !312 ; [#uses=3 type=i8] [debug line = 55:10]
  call void @llvm.dbg.value(metadata !{i8 %G}, i64 0, metadata !318), !dbg !312 ; [debug line = 55:10] [debug variable = G]
  %B = load i8* %in_channels_ch3_addr, align 1, !dbg !313 ; [#uses=4 type=i8] [debug line = 56:10]
  call void @llvm.dbg.value(metadata !{i8 %B}, i64 0, metadata !319), !dbg !313 ; [debug line = 56:10] [debug variable = B]
  %tmp_40_cast1 = zext i8 %R to i16, !dbg !320    ; [#uses=1 type=i16] [debug line = 57:10]
  %tmp_40_cast2 = zext i8 %R to i15, !dbg !320    ; [#uses=1 type=i15] [debug line = 57:10]
  %p_shl5 = call i14 @_ssdm_op_BitConcatenate.i14.i8.i6(i8 %R, i6 0), !dbg !320 ; [#uses=1 type=i14] [debug line = 57:10]
  %p_shl5_cast = zext i14 %p_shl5 to i15, !dbg !320 ; [#uses=1 type=i15] [debug line = 57:10]
  %p_shl6 = call i9 @_ssdm_op_BitConcatenate.i9.i8.i1(i8 %R, i1 false), !dbg !320 ; [#uses=1 type=i9] [debug line = 57:10]
  %p_shl6_cast = zext i9 %p_shl6 to i15, !dbg !320 ; [#uses=1 type=i15] [debug line = 57:10]
  %tmp_42_cast1 = zext i8 %G to i16, !dbg !320    ; [#uses=2 type=i16] [debug line = 57:10]
  %tmp_42_cast2 = zext i8 %G to i9, !dbg !320     ; [#uses=1 type=i9] [debug line = 57:10]
  %p_shl4 = call i15 @_ssdm_op_BitConcatenate.i15.i8.i7(i8 %G, i7 0), !dbg !320 ; [#uses=1 type=i15] [debug line = 57:10]
  %p_shl4_cast = zext i15 %p_shl4 to i16, !dbg !320 ; [#uses=1 type=i16] [debug line = 57:10]
  %tmp_44_cast1 = zext i8 %B to i13, !dbg !320    ; [#uses=1 type=i13] [debug line = 57:10]
  %tmp_20 = mul i13 25, %tmp_44_cast1, !dbg !320  ; [#uses=1 type=i13] [debug line = 57:10]
  %tmp2 = add i15 %p_shl6_cast, %p_shl5_cast, !dbg !320 ; [#uses=1 type=i15] [debug line = 57:10]
  %tmp2_cast = zext i15 %tmp2 to i16, !dbg !320   ; [#uses=1 type=i16] [debug line = 57:10]
  %tmp1 = add i16 %tmp2_cast, %p_shl4_cast, !dbg !320 ; [#uses=1 type=i16] [debug line = 57:10]
  %tmp4 = add i9 128, %tmp_42_cast2, !dbg !320    ; [#uses=1 type=i9] [debug line = 57:10]
  %tmp4_cast = zext i9 %tmp4 to i13, !dbg !320    ; [#uses=1 type=i13] [debug line = 57:10]
  %tmp3 = add i13 %tmp4_cast, %tmp_20, !dbg !320  ; [#uses=1 type=i13] [debug line = 57:10]
  %tmp3_cast = zext i13 %tmp3 to i16, !dbg !320   ; [#uses=1 type=i16] [debug line = 57:10]
  %tmp_22 = add i16 %tmp3_cast, %tmp1, !dbg !320  ; [#uses=1 type=i16] [debug line = 57:10]
  %tmp_23 = call i8 @_ssdm_op_PartSelect.i8.i16.i32.i32(i16 %tmp_22, i32 8, i32 15), !dbg !320 ; [#uses=1 type=i8] [debug line = 57:10]
  %Y = add i8 16, %tmp_23, !dbg !320              ; [#uses=1 type=i8] [debug line = 57:10]
  call void @llvm.dbg.value(metadata !{i8 %Y}, i64 0, metadata !321), !dbg !320 ; [debug line = 57:10] [debug variable = Y]
  %tmp_24 = mul i15 -38, %tmp_40_cast2, !dbg !322 ; [#uses=1 type=i15] [debug line = 58:10]
  %tmp_51_cast = sext i15 %tmp_24 to i16, !dbg !322 ; [#uses=1 type=i16] [debug line = 58:10]
  %tmp_25 = mul i16 -74, %tmp_42_cast1, !dbg !322 ; [#uses=1 type=i16] [debug line = 58:10]
  %p_shl2 = call i15 @_ssdm_op_BitConcatenate.i15.i8.i7(i8 %B, i7 0), !dbg !322 ; [#uses=1 type=i15] [debug line = 58:10]
  %p_shl2_cast = zext i15 %p_shl2 to i16, !dbg !322 ; [#uses=1 type=i16] [debug line = 58:10]
  %p_shl3 = call i12 @_ssdm_op_BitConcatenate.i12.i8.i4(i8 %B, i4 0), !dbg !322 ; [#uses=2 type=i12] [debug line = 58:10]
  %p_shl3_cast9 = zext i12 %p_shl3 to i13, !dbg !322 ; [#uses=1 type=i13] [debug line = 58:10]
  %p_shl3_cast = zext i12 %p_shl3 to i16, !dbg !322 ; [#uses=1 type=i16] [debug line = 58:10]
  %tmp_26 = sub i16 %p_shl2_cast, %p_shl3_cast, !dbg !322 ; [#uses=1 type=i16] [debug line = 58:10]
  %tmp5 = add i16 %tmp_51_cast, %tmp_25, !dbg !322 ; [#uses=1 type=i16] [debug line = 58:10]
  %tmp6 = add i16 128, %tmp_26, !dbg !322         ; [#uses=1 type=i16] [debug line = 58:10]
  %tmp_27 = add i16 %tmp6, %tmp5, !dbg !322       ; [#uses=1 type=i16] [debug line = 58:10]
  %tmp_28 = call i8 @_ssdm_op_PartSelect.i8.i16.i32.i32(i16 %tmp_27, i32 8, i32 15), !dbg !322 ; [#uses=1 type=i8] [debug line = 58:10]
  %U = xor i8 %tmp_28, -128, !dbg !322            ; [#uses=1 type=i8] [debug line = 58:10]
  call void @llvm.dbg.value(metadata !{i8 %U}, i64 0, metadata !323), !dbg !322 ; [debug line = 58:10] [debug variable = U]
  %tmp_29 = mul i16 122, %tmp_40_cast1, !dbg !324 ; [#uses=1 type=i16] [debug line = 59:10]
  %tmp_30 = mul i16 -94, %tmp_42_cast1, !dbg !324 ; [#uses=1 type=i16] [debug line = 59:10]
  %p_neg = sub i13 0, %p_shl3_cast9               ; [#uses=1 type=i13]
  %p_neg_cast = sext i13 %p_neg to i14            ; [#uses=1 type=i14]
  %p_shl1 = call i9 @_ssdm_op_BitConcatenate.i9.i8.i1(i8 %B, i1 false), !dbg !324 ; [#uses=1 type=i9] [debug line = 59:10]
  %p_shl1_cast = zext i9 %p_shl1 to i14, !dbg !324 ; [#uses=1 type=i14] [debug line = 59:10]
  %tmp_31 = sub i14 %p_neg_cast, %p_shl1_cast, !dbg !324 ; [#uses=1 type=i14] [debug line = 59:10]
  %tmp7 = add i16 %tmp_29, %tmp_30, !dbg !324     ; [#uses=1 type=i16] [debug line = 59:10]
  %tmp8 = add i14 128, %tmp_31, !dbg !324         ; [#uses=1 type=i14] [debug line = 59:10]
  %tmp8_cast = sext i14 %tmp8 to i16, !dbg !324   ; [#uses=1 type=i16] [debug line = 59:10]
  %tmp_32 = add i16 %tmp8_cast, %tmp7, !dbg !324  ; [#uses=1 type=i16] [debug line = 59:10]
  %tmp_33 = call i8 @_ssdm_op_PartSelect.i8.i16.i32.i32(i16 %tmp_32, i32 8, i32 15), !dbg !324 ; [#uses=1 type=i8] [debug line = 59:10]
  %V = xor i8 %tmp_33, -128, !dbg !324            ; [#uses=1 type=i8] [debug line = 59:10]
  call void @llvm.dbg.value(metadata !{i8 %V}, i64 0, metadata !325), !dbg !324 ; [debug line = 59:10] [debug variable = V]
  store i8 %Y, i8* %out_channels_ch1_add, align 1, !dbg !314 ; [debug line = 60:10]
  store i8 %U, i8* %out_channels_ch2_add, align 1, !dbg !315 ; [debug line = 61:10]
  store i8 %V, i8* %out_channels_ch3_add, align 1, !dbg !316 ; [debug line = 62:10]
  %y_3 = add i16 1, %y_mid2, !dbg !326            ; [#uses=1 type=i16] [debug line = 52:27]
  call void @llvm.dbg.value(metadata !{i16 %y_3}, i64 0, metadata !327), !dbg !326 ; [debug line = 52:27] [debug variable = y]
  br label %1, !dbg !326                          ; [debug line = 52:27]

; <label>:2                                       ; preds = %1
  call void @llvm.dbg.value(metadata !{i16 %in_width_read}, i64 0, metadata !289), !dbg !287 ; [debug line = 31:16] [debug variable = out.width]
  call void @llvm.dbg.value(metadata !{i16 %in_height_read}, i64 0, metadata !285), !dbg !287 ; [debug line = 31:16] [debug variable = out.height]
  %mrv = insertvalue { i16, i16 } undef, i16 %in_width_read_3, 0, !dbg !328 ; [#uses=1 type={ i16, i16 }] [debug line = 65:1]
  %mrv_1 = insertvalue { i16, i16 } %mrv, i16 %in_height_read11, 1, !dbg !328 ; [#uses=1 type={ i16, i16 }] [debug line = 65:1]
  ret { i16, i16 } %mrv_1, !dbg !328              ; [debug line = 65:1]
}
...
!15 = metadata !{i32 786473, metadata !"yuv_filter.c", metadata !"C:\5CUsers\5CUser\5CDesktop\5CUNI\5CEmbeddedRealTimeSystem\5CAssignment2\5CHLS_labs\5Clab2", null} ; [ DW_TAG_file_type ]
...
!21 = metadata !{i32 786473, metadata !"./image_aux.h", metadata !"C:\5CUsers\5CUser\5CDesktop\5CUNI\5CEmbeddedRealTimeSystem\5CAssignment2\5CHLS_labs\5Clab2", null} ; [ DW_TAG_file_type ]
...
!247 = metadata !{i32 90, i32 1, metadata !248, null}
!248 = metadata !{i32 786443, metadata !246, i32 89, i32 28, metadata !15, i32 8} ; [ DW_TAG_lexical_block ]
!249 = metadata !{i32 786688, metadata !241, metadata !"x", metadata !15, i32 72, metadata !37, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!250 = metadata !{i32 89, i32 23, metadata !246, null}
!251 = metadata !{i32 92, i32 12, metadata !252, null}
!252 = metadata !{i32 786443, metadata !248, i32 92, i32 7, metadata !15, i32 9} ; [ DW_TAG_lexical_block ]
!253 = metadata !{i32 94, i32 2, metadata !254, null}
!254 = metadata !{i32 786443, metadata !252, i32 92, i32 32, metadata !15, i32 10} ; [ DW_TAG_lexical_block ]
!255 = metadata !{i32 92, i32 33, metadata !254, null}
!256 = metadata !{i32 95, i32 10, metadata !254, null}
!257 = metadata !{i32 96, i32 10, metadata !254, null}
!258 = metadata !{i32 103, i32 10, metadata !254, null}
!259 = metadata !{i32 104, i32 10, metadata !254, null}
!260 = metadata !{i32 105, i32 10, metadata !254, null}
...
!264 = metadata !{i32 97, i32 10, metadata !254, null}
...
!276 = metadata !{i32 102, i32 10, metadata !254, null}
!277 = metadata !{i32 786688, metadata !241, metadata !"B", metadata !15, i32 74, metadata !29, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!278 = metadata !{i32 92, i32 27, metadata !252, null}
!279 = metadata !{i32 786688, metadata !241, metadata !"y", metadata !15, i32 72, metadata !37, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!280 = metadata !{i32 108, i32 1, metadata !241, null}
!281 = metadata !{i32 790533, metadata !282, metadata !"in.height", null, i32 30, metadata !50, i32 0, i32 0} ; [ DW_TAG_arg_variable_field_ro ]
!282 = metadata !{i32 786689, metadata !283, metadata !"in", metadata !15, i32 16777246, metadata !18, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!283 = metadata !{i32 786478, i32 0, metadata !15, metadata !"rgb2yuv", metadata !"rgb2yuv", metadata !"", metadata !15, i32 29, metadata !226, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !41, i32 33} ; [ DW_TAG_subprogram ]
!284 = metadata !{i32 30, i32 16, metadata !283, null}
!285 = metadata !{i32 790535, metadata !286, metadata !"out.height", null, i32 31, metadata !50, i32 0, i32 0} ; [ DW_TAG_arg_variable_field_wo ]
!286 = metadata !{i32 786689, metadata !283, metadata !"out", metadata !15, i32 33554463, metadata !18, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!287 = metadata !{i32 31, i32 16, metadata !283, null}
!288 = metadata !{i32 790533, metadata !282, metadata !"in.width", null, i32 30, metadata !58, i32 0, i32 0} ; [ DW_TAG_arg_variable_field_ro ]
!289 = metadata !{i32 790535, metadata !286, metadata !"out.width", null, i32 31, metadata !58, i32 0, i32 0} ; [ DW_TAG_arg_variable_field_wo ]
!290 = metadata !{i32 790531, metadata !282, metadata !"in.channels.ch1", null, i32 30, metadata !63, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!291 = metadata !{i32 790531, metadata !282, metadata !"in.channels.ch2", null, i32 30, metadata !69, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!292 = metadata !{i32 790531, metadata !282, metadata !"in.channels.ch3", null, i32 30, metadata !75, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!293 = metadata !{i32 790531, metadata !286, metadata !"out.channels.ch1", null, i32 31, metadata !63, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!294 = metadata !{i32 790531, metadata !286, metadata !"out.channels.ch2", null, i32 31, metadata !69, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!295 = metadata !{i32 790531, metadata !286, metadata !"out.channels.ch3", null, i32 31, metadata !75, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!296 = metadata !{i32 786688, metadata !297, metadata !"width", metadata !15, i32 35, metadata !37, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!297 = metadata !{i32 786443, metadata !283, i32 33, i32 1, metadata !15, i32 1} ; [ DW_TAG_lexical_block ]
!298 = metadata !{i32 43, i32 4, metadata !297, null}
!299 = metadata !{i32 786688, metadata !297, metadata !"height", metadata !15, i32 35, metadata !37, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!300 = metadata !{i32 44, i32 4, metadata !297, null}
!301 = metadata !{i32 49, i32 9, metadata !302, null}
!302 = metadata !{i32 786443, metadata !297, i32 49, i32 4, metadata !15, i32 2} ; [ DW_TAG_lexical_block ]
!303 = metadata !{i32 50, i32 1, metadata !304, null}
!304 = metadata !{i32 786443, metadata !302, i32 49, i32 28, metadata !15, i32 3} ; [ DW_TAG_lexical_block ]
!305 = metadata !{i32 786688, metadata !297, metadata !"x", metadata !15, i32 34, metadata !37, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!306 = metadata !{i32 49, i32 23, metadata !302, null}
!307 = metadata !{i32 52, i32 12, metadata !308, null}
!308 = metadata !{i32 786443, metadata !304, i32 52, i32 7, metadata !15, i32 4} ; [ DW_TAG_lexical_block ]
!309 = metadata !{i32 54, i32 2, metadata !310, null}
!310 = metadata !{i32 786443, metadata !308, i32 52, i32 32, metadata !15, i32 5} ; [ DW_TAG_lexical_block ]
!311 = metadata !{i32 52, i32 33, metadata !310, null}
!312 = metadata !{i32 55, i32 10, metadata !310, null}
!313 = metadata !{i32 56, i32 10, metadata !310, null}
!314 = metadata !{i32 60, i32 10, metadata !310, null}
!315 = metadata !{i32 61, i32 10, metadata !310, null}
!316 = metadata !{i32 62, i32 10, metadata !310, null}
!317 = metadata !{i32 786688, metadata !297, metadata !"R", metadata !15, i32 36, metadata !29, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!318 = metadata !{i32 786688, metadata !297, metadata !"G", metadata !15, i32 36, metadata !29, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!319 = metadata !{i32 786688, metadata !297, metadata !"B", metadata !15, i32 36, metadata !29, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!320 = metadata !{i32 57, i32 10, metadata !310, null}
!321 = metadata !{i32 786688, metadata !297, metadata !"Y", metadata !15, i32 36, metadata !29, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!322 = metadata !{i32 58, i32 10, metadata !310, null}
!323 = metadata !{i32 786688, metadata !297, metadata !"U", metadata !15, i32 36, metadata !29, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!324 = metadata !{i32 59, i32 10, metadata !310, null}
!325 = metadata !{i32 786688, metadata !297, metadata !"V", metadata !15, i32 36, metadata !29, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!326 = metadata !{i32 52, i32 27, metadata !308, null}
!327 = metadata !{i32 786688, metadata !297, metadata !"y", metadata !15, i32 34, metadata !37, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!328 = metadata !{i32 65, i32 1, metadata !297, null}
