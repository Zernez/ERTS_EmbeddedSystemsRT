...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7", "12", "17"],
		"CDFG" : "yuv_filter",
		...
		"WaitState" : [
			...
			{"State" : "ap_ST_fsm_state6", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_yuv2rgb_fu_134"},
			{"State" : "ap_ST_fsm_state4", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_yuv_scale_fu_149"}],
		"Port" : [
			...
			{"Name" : "out_channels_ch1", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "12", "SubInstance" : "grp_yuv2rgb_fu_134", "Port" : "out_channels_ch1"}]},
			{"Name" : "out_channels_ch2", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "12", "SubInstance" : "grp_yuv2rgb_fu_134", "Port" : "out_channels_ch2"}]},
			{"Name" : "out_channels_ch3", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "12", "SubInstance" : "grp_yuv2rgb_fu_134", "Port" : "out_channels_ch3"}]},
	...
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_rgb2yuv_fu_114", "Parent" : "0", "Child" : ["8", "9", "10", "11"],
		"CDFG" : "rgb2yuv",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"Combinational" : "0",
		...
		"Port" : [
			...
			{"Name" : "out_channels_ch2", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "out_channels_ch3", "Type" : "Memory", "Direction" : "O"}]},
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_rgb2yuv_fu_114.yuv_filter_mul_mubkb_U0", "Parent" : "7"},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_rgb2yuv_fu_114.yuv_filter_mac_mucud_U1", "Parent" : "7"},
	{"ID" : "10", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_rgb2yuv_fu_114.yuv_filter_mac_mudEe_U2", "Parent" : "7"},
	{"ID" : "11", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_rgb2yuv_fu_114.yuv_filter_mac_mueOg_U3", "Parent" : "7"},
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_yuv2rgb_fu_134", "Parent" : "0", "Child" : ["13", "14", "15", "16"],
		"CDFG" : "yuv2rgb",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"Combinational" : "0",
		...
		"Port" : [
			...
			{"Name" : "out_channels_ch2", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "out_channels_ch3", "Type" : "Memory", "Direction" : "O"}]},
	{"ID" : "13", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_yuv2rgb_fu_134.yuv_filter_mul_mubkb_x_U24", "Parent" : "12"},
	{"ID" : "14", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_yuv2rgb_fu_134.yuv_filter_ama_adfYi_U25", "Parent" : "12"},
	{"ID" : "15", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_yuv2rgb_fu_134.yuv_filter_mac_mug8j_U26", "Parent" : "12"},
	{"ID" : "16", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_yuv2rgb_fu_134.yuv_filter_mac_muhbi_U27", "Parent" : "12"},
	{"ID" : "17", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_yuv_scale_fu_149", "Parent" : "0", "Child" : ["18"],
		"CDFG" : "yuv_scale",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"Combinational" : "0",
		...
		"Port" : [
			...
			{"Name" : "U_scale", "Type" : "None", "Direction" : "I"},
			{"Name" : "V_scale", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "18", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_yuv_scale_fu_149.yuv_filter_mul_mubkb_x_U12", "Parent" : "17"}]}
...
set ArgLastReadFirstWriteLatency {
	...
	yuv2rgb {
		in_channels_ch1 {Type I LastRead 4 FirstWrite -1}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "120035", "Max" : "7372835"}
	, {"Name" : "Interval", "Min" : "120036", "Max" : "7372836"}
]}
