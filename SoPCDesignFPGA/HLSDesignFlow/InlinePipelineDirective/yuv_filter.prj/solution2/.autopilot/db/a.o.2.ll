; ModuleID = 'C:/Users/User/Desktop/UNI/EmbeddedRealTimeSystem/Assignment2/HLS_labs/lab2/yuv_filter.prj/solution2/.autopilot/db/a.o.2.bc'
...
; <label>:2                                       ; preds = %1
  ...
  %tmp.3 = zext i16 %x to i32, !dbg !118          ; [#uses=6 type=i32] [debug line = 134:2]
...
; <label>:4                                       ; preds = %3
  ...
  %tmp.5 = zext i16 %y to i32, !dbg !118          ; [#uses=6 type=i32] [debug line = 134:2]
  %in.channels.ch1.addr = getelementptr [1920 x [1280 x i8]]* %in.channels.ch1, i32 0, i32 %tmp.3, i32 %tmp.5, !dbg !118 ; [#uses=1 type=i8*] [debug line = 134:2]
  ...
  %in.channels.ch2.addr = getelementptr [1920 x [1280 x i8]]* %in.channels.ch2, i32 0, i32 %tmp.3, i32 %tmp.5, !dbg !123 ; [#uses=1 type=i8*] [debug line = 135:10]
  ...
  %in.channels.ch3.addr = getelementptr [1920 x [1280 x i8]]* %in.channels.ch3, i32 0, i32 %tmp.3, i32 %tmp.5, !dbg !125 ; [#uses=1 type=i8*] [debug line = 136:10]
  ...
  %out.channels.ch1.addr = getelementptr [1920 x [1280 x i8]]* %out.channels.ch1, i32 0, i32 %tmp.3, i32 %tmp.5, !dbg !132 ; [#uses=1 type=i8*] [debug line = 140:10]
  ...
  %out.channels.ch2.addr = getelementptr [1920 x [1280 x i8]]* %out.channels.ch2, i32 0, i32 %tmp.3, i32 %tmp.5, !dbg !133 ; [#uses=1 type=i8*] [debug line = 141:10]
  ...
  %out.channels.ch3.addr = getelementptr [1920 x [1280 x i8]]* %out.channels.ch3, i32 0, i32 %tmp.3, i32 %tmp.5, !dbg !134 ; [#uses=1 type=i8*] [debug line = 142:10]
...
; <label>:2                                       ; preds = %1
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !273 ; [debug line = 90:1]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 200, i32 1920, i32 1060, [1 x i8]* @.str1) nounwind, !dbg !273 ; [debug line = 90:1]
  %tmp = zext i16 %x to i32, !dbg !274            ; [#uses=6 type=i32] [debug line = 94:2]
...
_ifconv:                                          ; preds = %3
  ...
  %tmp. = zext i16 %y to i32, !dbg !274           ; [#uses=6 type=i32] [debug line = 94:2]
  %in.channels.ch1.addr = getelementptr [1920 x [1280 x i8]]* %in.channels.ch1, i32 0, i32 %tmp, i32 %tmp., !dbg !274 ; [#uses=1 type=i8*] [debug line = 94:2]
  ...
  %in.channels.ch2.addr = getelementptr [1920 x [1280 x i8]]* %in.channels.ch2, i32 0, i32 %tmp, i32 %tmp., !dbg !281 ; [#uses=1 type=i8*] [debug line = 95:10]
  ...
  %in.channels.ch3.addr = getelementptr [1920 x [1280 x i8]]* %in.channels.ch3, i32 0, i32 %tmp, i32 %tmp., !dbg !283 ; [#uses=1 type=i8*] [debug line = 96:10]
  ...
  %out.channels.ch1.addr = getelementptr [1920 x [1280 x i8]]* %out.channels.ch1, i32 0, i32 %tmp, i32 %tmp., !dbg !297 ; [#uses=1 type=i8*] [debug line = 103:10]
  store i8 %R, i8* %out.channels.ch1.addr, align 1, !dbg !297 ; [debug line = 103:10]
  %out.channels.ch2.addr = getelementptr [1920 x [1280 x i8]]* %out.channels.ch2, i32 0, i32 %tmp, i32 %tmp., !dbg !298 ; [#uses=1 type=i8*] [debug line = 104:10]
  store i8 %G, i8* %out.channels.ch2.addr, align 1, !dbg !298 ; [debug line = 104:10]
  %out.channels.ch3.addr = getelementptr [1920 x [1280 x i8]]* %out.channels.ch3, i32 0, i32 %tmp, i32 %tmp., !dbg !299 ; [#uses=1 type=i8*] [debug line = 105:10]
...
; <label>:2                                       ; preds = %1
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !330 ; [debug line = 50:1]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 200, i32 1920, i32 1060, [1 x i8]* @.str1) nounwind, !dbg !330 ; [debug line = 50:1]
  %tmp = zext i16 %x to i32, !dbg !331            ; [#uses=6 type=i32] [debug line = 54:2]
...
; <label>:4                                       ; preds = %3
  ...
  %tmp. = zext i16 %y to i32, !dbg !331           ; [#uses=6 type=i32] [debug line = 54:2]
  %in.channels.ch1.addr = getelementptr [1920 x [1280 x i8]]* %in.channels.ch1, i32 0, i32 %tmp, i32 %tmp., !dbg !331 ; [#uses=1 type=i8*] [debug line = 54:2]
  ...
  %in.channels.ch2.addr = getelementptr [1920 x [1280 x i8]]* %in.channels.ch2, i32 0, i32 %tmp, i32 %tmp., !dbg !338 ; [#uses=1 type=i8*] [debug line = 55:10]
  ...
  %in.channels.ch3.addr = getelementptr [1920 x [1280 x i8]]* %in.channels.ch3, i32 0, i32 %tmp, i32 %tmp., !dbg !340 ; [#uses=1 type=i8*] [debug line = 56:10]
  ...
  %out.channels.ch1.addr = getelementptr [1920 x [1280 x i8]]* %out.channels.ch1, i32 0, i32 %tmp, i32 %tmp., !dbg !348 ; [#uses=1 type=i8*] [debug line = 60:10]
  store i8 %Y, i8* %out.channels.ch1.addr, align 1, !dbg !348 ; [debug line = 60:10]
  %out.channels.ch2.addr = getelementptr [1920 x [1280 x i8]]* %out.channels.ch2, i32 0, i32 %tmp, i32 %tmp., !dbg !349 ; [#uses=1 type=i8*] [debug line = 61:10]
  store i8 %U, i8* %out.channels.ch2.addr, align 1, !dbg !349 ; [debug line = 61:10]
  %out.channels.ch3.addr = getelementptr [1920 x [1280 x i8]]* %out.channels.ch3, i32 0, i32 %tmp, i32 %tmp., !dbg !350 ; [#uses=1 type=i8*] [debug line = 62:10]
...
!74 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !75} ; [ DW_TAG_pointer_type ]
