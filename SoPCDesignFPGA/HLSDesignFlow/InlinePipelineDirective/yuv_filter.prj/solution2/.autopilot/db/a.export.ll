...
.reset:                                           ; preds = %1
  ...
  %tmp_10_cast = zext i23 %tmp_5 to i32
  %in_channels_ch1_addr = getelementptr [2457600 x i8]* %in_channels_ch1, i32 0, i32 %tmp_10_cast
  %in_channels_ch2_addr = getelementptr [2457600 x i8]* %in_channels_ch2, i32 0, i32 %tmp_10_cast
  %in_channels_ch3_addr = getelementptr [2457600 x i8]* %in_channels_ch3, i32 0, i32 %tmp_10_cast
  %out_channels_ch1_add = getelementptr [2457600 x i8]* %out_channels_ch1, i32 0, i32 %tmp_10_cast
  %out_channels_ch2_add = getelementptr [2457600 x i8]* %out_channels_ch2, i32 0, i32 %tmp_10_cast
  %out_channels_ch3_add = getelementptr [2457600 x i8]* %out_channels_ch3, i32 0, i32 %tmp_10_cast
...
.reset:                                           ; preds = %1
  ...
  %tmp_28_cast = zext i23 %tmp_8 to i32
  %in_channels_ch1_addr = getelementptr [2457600 x i8]* %in_channels_ch1, i32 0, i32 %tmp_28_cast
  %in_channels_ch2_addr = getelementptr [2457600 x i8]* %in_channels_ch2, i32 0, i32 %tmp_28_cast
  %in_channels_ch3_addr = getelementptr [2457600 x i8]* %in_channels_ch3, i32 0, i32 %tmp_28_cast
  %out_channels_ch1_add = getelementptr [2457600 x i8]* %out_channels_ch1, i32 0, i32 %tmp_28_cast
  %out_channels_ch2_add = getelementptr [2457600 x i8]* %out_channels_ch2, i32 0, i32 %tmp_28_cast
  %out_channels_ch3_add = getelementptr [2457600 x i8]* %out_channels_ch3, i32 0, i32 %tmp_28_cast
  %Y = load i8* %in_channels_ch1_addr, align 1
  %U = load i8* %in_channels_ch2_addr, align 1
  %V = load i8* %in_channels_ch3_addr, align 1
...
.reset:                                           ; preds = %1
  ...
  %tmp_cast = zext i16 %y_mid2 to i23
  %tmp_19 = add i23 %tmp_cast, %tmp_s
  %tmp_42_cast = zext i23 %tmp_19 to i32
  %in_channels_ch1_addr = getelementptr [2457600 x i8]* %in_channels_ch1, i32 0, i32 %tmp_42_cast
  %in_channels_ch2_addr = getelementptr [2457600 x i8]* %in_channels_ch2, i32 0, i32 %tmp_42_cast
  %in_channels_ch3_addr = getelementptr [2457600 x i8]* %in_channels_ch3, i32 0, i32 %tmp_42_cast
  %out_channels_ch1_add = getelementptr [2457600 x i8]* %out_channels_ch1, i32 0, i32 %tmp_42_cast
  %out_channels_ch2_add = getelementptr [2457600 x i8]* %out_channels_ch2, i32 0, i32 %tmp_42_cast
  %out_channels_ch3_add = getelementptr [2457600 x i8]* %out_channels_ch3, i32 0, i32 %tmp_42_cast
  ...
  %tmp_20 = mul i13 25, %tmp_44_cast1
  ...
  %tmp3 = add i13 %tmp4_cast, %tmp_20
  %tmp3_cast = zext i13 %tmp3 to i16
  %tmp_22 = add i16 %tmp3_cast, %tmp1
  %tmp_23 = call i8 @_ssdm_op_PartSelect.i8.i16.i32.i32(i16 %tmp_22, i32 8, i32 15)
  %Y = add i8 16, %tmp_23
  %tmp_24 = mul i15 -38, %tmp_40_cast2
  %tmp_51_cast = sext i15 %tmp_24 to i16
  %tmp_25 = mul i16 -74, %tmp_42_cast1
  ...
  %tmp_26 = sub i16 %p_shl2_cast, %p_shl3_cast
  %tmp5 = add i16 %tmp_51_cast, %tmp_25
  %tmp6 = add i16 128, %tmp_26
  %tmp_27 = add i16 %tmp6, %tmp5
  %tmp_28 = call i8 @_ssdm_op_PartSelect.i8.i16.i32.i32(i16 %tmp_27, i32 8, i32 15)
  %U = xor i8 %tmp_28, -128
  %tmp_29 = mul i16 122, %tmp_40_cast1
  %tmp_30 = mul i16 -94, %tmp_42_cast1
  ...
  %tmp_31 = sub i14 %p_neg_cast, %p_shl1_cast
  %tmp7 = add i16 %tmp_29, %tmp_30
  %tmp8 = add i14 128, %tmp_31
  %tmp8_cast = sext i14 %tmp8 to i16
  %tmp_32 = add i16 %tmp8_cast, %tmp7
  %tmp_33 = call i8 @_ssdm_op_PartSelect.i8.i16.i32.i32(i16 %tmp_32, i32 8, i32 15)
  %V = xor i8 %tmp_33, -128
