...
#ifndef __yuv_filter_mac_muhbi__HH__
#define __yuv_filter_mac_muhbi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(yuv_filter_mac_muhbi) {
    ...
    SC_CTOR(yuv_filter_mac_muhbi):  simcore_mac_4_U ("simcore_mac_4_U") {
