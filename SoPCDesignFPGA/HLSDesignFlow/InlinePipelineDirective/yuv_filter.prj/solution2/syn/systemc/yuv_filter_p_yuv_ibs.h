...
#ifndef __yuv_filter_p_yuv_ibs_H__
#define __yuv_filter_p_yuv_ibs_H__
...
struct yuv_filter_p_yuv_ibs_ram : public sc_core::sc_module {
...
sc_core::sc_signal<sc_lv<DataWidth> > q0_t1;
   SC_CTOR(yuv_filter_p_yuv_ibs_ram) {
...
SC_MODULE(yuv_filter_p_yuv_ibs) {
...
yuv_filter_p_yuv_ibs_ram* meminst;


SC_CTOR(yuv_filter_p_yuv_ibs) {
meminst = new yuv_filter_p_yuv_ibs_ram("yuv_filter_p_yuv_ibs_ram");
