...
#ifndef __yuv_filter_mul_mubkb__HH__
#define __yuv_filter_mul_mubkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(yuv_filter_mul_mubkb) {
    ...
    SC_CTOR(yuv_filter_mul_mubkb):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
