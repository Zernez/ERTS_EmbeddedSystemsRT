...
#ifndef __yuv_filter_mac_mufYi__HH__
#define __yuv_filter_mac_mufYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(yuv_filter_mac_mufYi) {
    ...
    SC_CTOR(yuv_filter_mac_mufYi):  simcore_mac_3_U ("simcore_mac_3_U") {
