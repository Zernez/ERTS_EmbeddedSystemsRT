...
entity yuv_filter_p_yuv_hbi_ram is 
    generic(
...
architecture rtl of yuv_filter_p_yuv_hbi_ram is 
...
entity yuv_filter_p_yuv_hbi is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of yuv_filter_p_yuv_hbi is
    component yuv_filter_p_yuv_hbi_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    yuv_filter_p_yuv_hbi_ram_U :  component yuv_filter_p_yuv_hbi_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
