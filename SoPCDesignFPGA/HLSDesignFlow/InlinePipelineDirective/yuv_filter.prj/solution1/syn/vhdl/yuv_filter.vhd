...
architecture behav of yuv_filter is 
    ...
    "yuv_filter,hls_ip_2017_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010clg400-1,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.849000,HLS_SYN_LAT=18831965,HLS_SYN_TPT=none,HLS_SYN_MEM=12288,HLS_SYN_DSP=6,HLS_SYN_FF=1992,HLS_SYN_LUT=1528}";
    ...
    signal tmp_3_cast_fu_360_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_3_cast_reg_489 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    tmp_3_cast_reg_489(31 downto 23) <= "000000000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, grp_rgb2yuv_fu_244_ap_done, ap_CS_fsm_state3, exitcond1_i_fu_299_p2, ap_CS_fsm_state4, exitcond_i_fu_340_p2, grp_yuv2rgb_fu_264_ap_done, ap_CS_fsm_state11)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state11 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state11) and (grp_yuv2rgb_fu_264_ap_done = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state11;
                end if;
    ...
    ap_done_assign_proc : process(grp_yuv2rgb_fu_264_ap_done, ap_CS_fsm_state11)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state11) and (grp_yuv2rgb_fu_264_ap_done = ap_const_logic_1))) then 
    ...
    ap_ready_assign_proc : process(grp_yuv2rgb_fu_264_ap_done, ap_CS_fsm_state11)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state11) and (grp_yuv2rgb_fu_264_ap_done = ap_const_logic_1))) then 
    ...
    out_height_ap_vld_assign_proc : process(grp_yuv2rgb_fu_264_ap_done, ap_CS_fsm_state11)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state11) and (grp_yuv2rgb_fu_264_ap_done = ap_const_logic_1))) then 
    ...
    out_width_ap_vld_assign_proc : process(grp_yuv2rgb_fu_264_ap_done, ap_CS_fsm_state11)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state11) and (grp_yuv2rgb_fu_264_ap_done = ap_const_logic_1))) then 
    ...
    p_scale_channels_ch1_address0_assign_proc : process(tmp_3_cast_reg_489, ap_CS_fsm_state9, grp_yuv2rgb_fu_264_in_channels_ch1_address0, ap_CS_fsm_state11)
    begin
    ...
    p_scale_channels_ch1_ce0_assign_proc : process(ap_CS_fsm_state9, grp_yuv2rgb_fu_264_in_channels_ch1_ce0, ap_CS_fsm_state10, ap_CS_fsm_state11)
    begin
    ...
    p_scale_channels_ch1_we0_assign_proc : process(ap_CS_fsm_state9)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
    ...
    p_scale_channels_ch2_address0_assign_proc : process(tmp_3_cast_reg_489, ap_CS_fsm_state9, grp_yuv2rgb_fu_264_in_channels_ch2_address0, ap_CS_fsm_state11)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
    ...
    p_scale_channels_ch2_ce0_assign_proc : process(ap_CS_fsm_state9, grp_yuv2rgb_fu_264_in_channels_ch2_ce0, ap_CS_fsm_state10, ap_CS_fsm_state11)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state9) or (ap_const_logic_1 = ap_CS_fsm_state10))) then 
    ...
    p_scale_channels_ch2_we0_assign_proc : process(ap_CS_fsm_state9)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
    ...
    p_scale_channels_ch3_address0_assign_proc : process(tmp_3_cast_reg_489, ap_CS_fsm_state9, grp_yuv2rgb_fu_264_in_channels_ch3_address0, ap_CS_fsm_state11)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
    ...
    p_scale_channels_ch3_ce0_assign_proc : process(ap_CS_fsm_state9, grp_yuv2rgb_fu_264_in_channels_ch3_ce0, ap_CS_fsm_state10, ap_CS_fsm_state11)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state9) or (ap_const_logic_1 = ap_CS_fsm_state10))) then 
    ...
    p_scale_channels_ch3_we0_assign_proc : process(ap_CS_fsm_state9)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
    ...
    tmp_3_cast_fu_360_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_3_fu_355_p2),32));
    ...
    tmp_7_i_fu_370_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(Y_reg_511),15));
    tmp_7_i_fu_370_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_7_i_fu_370_p0) * unsigned(tmp_7_i_fu_370_p1), 15));
    tmp_8_i_fu_386_p0 <= tmp_2_i_cast_reg_463(8 - 1 downto 0);
    tmp_8_i_fu_386_p1 <= tmp_8_i_fu_386_p10(8 - 1 downto 0);
    tmp_8_i_fu_386_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(V_reg_521),15));
    tmp_8_i_fu_386_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_8_i_fu_386_p0) * unsigned(tmp_8_i_fu_386_p1), 15));
    ...
    tmp_i_fu_378_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(U_reg_516),15));
    tmp_i_fu_378_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_i_fu_378_p0) * unsigned(tmp_i_fu_378_p1), 15));
