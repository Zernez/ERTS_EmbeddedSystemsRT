...
(* CORE_GENERATION_INFO="yuv_filter,hls_ip_2017_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010clg400-1,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.849000,HLS_SYN_LAT=18831965,HLS_SYN_TPT=none,HLS_SYN_MEM=12288,HLS_SYN_DSP=6,HLS_SYN_FF=1992,HLS_SYN_LUT=1528}" *)
...
wire   [31:0] tmp_3_cast_fu_360_p1;
reg   [31:0] tmp_3_cast_reg_489;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        tmp_10_i_reg_526 <= {{tmp_7_i_fu_370_p2[14:7]}};
        tmp_11_i_reg_531 <= {{tmp_i_fu_378_p2[14:7]}};
        tmp_12_i_reg_536 <= {{tmp_8_i_fu_386_p2[14:7]}};
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state11) & (grp_yuv2rgb_fu_264_ap_done == 1'b1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (posedge ap_clk) begin
    ...
    tmp_3_cast_reg_489[31:23] <= 9'b000000000;
end
