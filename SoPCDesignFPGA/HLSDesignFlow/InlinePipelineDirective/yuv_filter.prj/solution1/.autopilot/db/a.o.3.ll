; ModuleID = 'C:/Users/User/Desktop/UNI/EmbeddedRealTimeSystem/Assignment2/HLS_labs/lab2/yuv_filter.prj/solution1/.autopilot/db/a.o.3.bc'
...
; <label>:2                                       ; preds = %1
  ...
  %p_shl3_cast = call i23 @_ssdm_op_BitConcatenate.i23.i15.i8(i15 %tmp_1, i8 0), !dbg !201 ; [#uses=1 type=i23] [debug line = 136:10@24:4]
  %tmp_2 = add i23 %p_shl_cast, %p_shl3_cast, !dbg !201 ; [#uses=1 type=i23] [debug line = 136:10@24:4]
...
; <label>:4                                       ; preds = %3
  ...
  %tmp_5_i_cast = zext i16 %y_i to i23, !dbg !201 ; [#uses=1 type=i23] [debug line = 136:10@24:4]
  %tmp_3 = add i23 %tmp_2, %tmp_5_i_cast, !dbg !201 ; [#uses=1 type=i23] [debug line = 136:10@24:4]
  %tmp_3_cast = zext i23 %tmp_3 to i32, !dbg !201 ; [#uses=6 type=i32] [debug line = 136:10@24:4]
  %yuv_channels_ch3_add = getelementptr [2457600 x i8]* %p_yuv_channels_ch3, i32 0, i32 %tmp_3_cast, !dbg !201 ; [#uses=1 type=i8*] [debug line = 136:10@24:4]
  %scale_channels_ch1_a = getelementptr [2457600 x i8]* %p_scale_channels_ch1, i32 0, i32 %tmp_3_cast, !dbg !206 ; [#uses=1 type=i8*] [debug line = 140:10@24:4]
  %scale_channels_ch3_a = getelementptr [2457600 x i8]* %p_scale_channels_ch3, i32 0, i32 %tmp_3_cast, !dbg !207 ; [#uses=1 type=i8*] [debug line = 142:10@24:4]
  %scale_channels_ch2_a = getelementptr [2457600 x i8]* %p_scale_channels_ch2, i32 0, i32 %tmp_3_cast, !dbg !208 ; [#uses=1 type=i8*] [debug line = 141:10@24:4]
  %yuv_channels_ch1_add = getelementptr [2457600 x i8]* %p_yuv_channels_ch1, i32 0, i32 %tmp_3_cast, !dbg !209 ; [#uses=1 type=i8*] [debug line = 134:2@24:4]
  %yuv_channels_ch2_add = getelementptr [2457600 x i8]* %p_yuv_channels_ch2, i32 0, i32 %tmp_3_cast, !dbg !210 ; [#uses=1 type=i8*] [debug line = 135:10@24:4]
  ...
  %U = load i8* %yuv_channels_ch2_add, align 1, !dbg !210 ; [#uses=1 type=i8] [debug line = 135:10@24:4]
  call void @llvm.dbg.value(metadata !{i8 %U}, i64 0, metadata !212), !dbg !210 ; [debug line = 135:10@24:4] [debug variable = U]
  %V = load i8* %yuv_channels_ch3_add, align 1, !dbg !201 ; [#uses=1 type=i8] [debug line = 136:10@24:4]
  call void @llvm.dbg.value(metadata !{i8 %V}, i64 0, metadata !213), !dbg !201 ; [debug line = 136:10@24:4] [debug variable = V]
  ...
  %tmp_11_i = call i8 @_ssdm_op_PartSelect.i8.i15.i32.i32(i15 %tmp_i, i32 7, i32 14), !dbg !208 ; [#uses=1 type=i8] [debug line = 141:10@24:4]
  store i8 %tmp_11_i, i8* %scale_channels_ch2_a, align 1, !dbg !208 ; [debug line = 141:10@24:4]
  %tmp_12_i = call i8 @_ssdm_op_PartSelect.i8.i15.i32.i32(i15 %tmp_8_i, i32 7, i32 14), !dbg !207 ; [#uses=1 type=i8] [debug line = 142:10@24:4]
  store i8 %tmp_12_i, i8* %scale_channels_ch3_a, align 1, !dbg !207 ; [debug line = 142:10@24:4]
...
_ifconv:                                          ; preds = %3
  ...
  %tmp_21_cast = zext i23 %tmp_6 to i32, !dbg !253 ; [#uses=6 type=i32] [debug line = 94:2]
  %in_channels_ch1_addr = getelementptr [2457600 x i8]* %in_channels_ch1, i32 0, i32 %tmp_21_cast, !dbg !253 ; [#uses=1 type=i8*] [debug line = 94:2]
  %in_channels_ch2_addr = getelementptr [2457600 x i8]* %in_channels_ch2, i32 0, i32 %tmp_21_cast, !dbg !260 ; [#uses=1 type=i8*] [debug line = 95:10]
  %in_channels_ch3_addr = getelementptr [2457600 x i8]* %in_channels_ch3, i32 0, i32 %tmp_21_cast, !dbg !261 ; [#uses=1 type=i8*] [debug line = 96:10]
  %out_channels_ch1_add = getelementptr [2457600 x i8]* %out_channels_ch1, i32 0, i32 %tmp_21_cast, !dbg !262 ; [#uses=1 type=i8*] [debug line = 103:10]
  %out_channels_ch2_add = getelementptr [2457600 x i8]* %out_channels_ch2, i32 0, i32 %tmp_21_cast, !dbg !263 ; [#uses=1 type=i8*] [debug line = 104:10]
  %out_channels_ch3_add = getelementptr [2457600 x i8]* %out_channels_ch3, i32 0, i32 %tmp_21_cast, !dbg !264 ; [#uses=1 type=i8*] [debug line = 105:10]
...
; <label>:4                                       ; preds = %3
  ...
  %tmp_24_cast = zext i23 %tmp_24 to i32, !dbg !313 ; [#uses=6 type=i32] [debug line = 54:2]
  %in_channels_ch1_addr = getelementptr [2457600 x i8]* %in_channels_ch1, i32 0, i32 %tmp_24_cast, !dbg !313 ; [#uses=1 type=i8*] [debug line = 54:2]
  %in_channels_ch2_addr = getelementptr [2457600 x i8]* %in_channels_ch2, i32 0, i32 %tmp_24_cast, !dbg !320 ; [#uses=1 type=i8*] [debug line = 55:10]
  %in_channels_ch3_addr = getelementptr [2457600 x i8]* %in_channels_ch3, i32 0, i32 %tmp_24_cast, !dbg !321 ; [#uses=1 type=i8*] [debug line = 56:10]
  %out_channels_ch1_add = getelementptr [2457600 x i8]* %out_channels_ch1, i32 0, i32 %tmp_24_cast, !dbg !322 ; [#uses=1 type=i8*] [debug line = 60:10]
  %out_channels_ch2_add = getelementptr [2457600 x i8]* %out_channels_ch2, i32 0, i32 %tmp_24_cast, !dbg !323 ; [#uses=1 type=i8*] [debug line = 61:10]
  %out_channels_ch3_add = getelementptr [2457600 x i8]* %out_channels_ch3, i32 0, i32 %tmp_24_cast, !dbg !324 ; [#uses=1 type=i8*] [debug line = 62:10]
...
!74 = metadata !{i32 786473, metadata !"yuv_filter.c", metadata !"C:\5CUsers\5CUser\5CDesktop\5CUNI\5CEmbeddedRealTimeSystem\5CAssignment2\5CHLS_labs\5Clab2", null} ; [ DW_TAG_file_type ]
...
!80 = metadata !{i32 786473, metadata !"./image_aux.h", metadata !"C:\5CUsers\5CUser\5CDesktop\5CUNI\5CEmbeddedRealTimeSystem\5CAssignment2\5CHLS_labs\5Clab2", null} ; [ DW_TAG_file_type ]
...
!131 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !132} ; [ DW_TAG_pointer_type ]
...
!137 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !138} ; [ DW_TAG_pointer_type ]
...
!141 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !142} ; [ DW_TAG_pointer_type ]
...
!201 = metadata !{i32 136, i32 10, metadata !192, metadata !105}
...
!207 = metadata !{i32 142, i32 10, metadata !192, metadata !105}
!208 = metadata !{i32 141, i32 10, metadata !192, metadata !105}
!209 = metadata !{i32 134, i32 2, metadata !192, metadata !105}
!210 = metadata !{i32 135, i32 10, metadata !192, metadata !105}
