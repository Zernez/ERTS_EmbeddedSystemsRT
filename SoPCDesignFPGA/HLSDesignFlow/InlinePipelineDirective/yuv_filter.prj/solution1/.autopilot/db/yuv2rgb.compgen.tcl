...
set out_width 18
set exp (i0+i1)*i2+i3
set arg_lists {i0 {5 1 +} i1 {8 0 +} s {9 1 +} i2 {10 0 +} m {18 1 +} i3 {9 0 +} p {18 1 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
set out_width 17
set exp i0*i1+i2
set arg_lists {i0 {8 1 +} i1 {8 1 +} m {16 1 +} i2 {17 0 +} p {17 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set out_width 18
set exp i0*i1+i2
set arg_lists {i0 {10 0 +} i1 {8 1 +} m {18 1 +} i2 {18 1 +} p {18 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
