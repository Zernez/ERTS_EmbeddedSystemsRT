...
set out_width 13
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {6 0 +} m {13 0 +} i2 {9 0 +} p {13 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
set out_width 16
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {7 1 +} m {15 1 +} i2 {16 0 +} p {16 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
