...
; <label>:4                                       ; preds = %3
  ...
  %tmp_3_cast = zext i23 %tmp_3 to i32
  %yuv_channels_ch3_add = getelementptr [2457600 x i8]* %p_yuv_channels_ch3, i32 0, i32 %tmp_3_cast
  %scale_channels_ch1_a = getelementptr [2457600 x i8]* %p_scale_channels_ch1, i32 0, i32 %tmp_3_cast
  %scale_channels_ch3_a = getelementptr [2457600 x i8]* %p_scale_channels_ch3, i32 0, i32 %tmp_3_cast
  %scale_channels_ch2_a = getelementptr [2457600 x i8]* %p_scale_channels_ch2, i32 0, i32 %tmp_3_cast
  %yuv_channels_ch1_add = getelementptr [2457600 x i8]* %p_yuv_channels_ch1, i32 0, i32 %tmp_3_cast
  %yuv_channels_ch2_add = getelementptr [2457600 x i8]* %p_yuv_channels_ch2, i32 0, i32 %tmp_3_cast
...
_ifconv:                                          ; preds = %3
  ...
  %tmp_21_cast = zext i23 %tmp_6 to i32
  %in_channels_ch1_addr = getelementptr [2457600 x i8]* %in_channels_ch1, i32 0, i32 %tmp_21_cast
  %in_channels_ch2_addr = getelementptr [2457600 x i8]* %in_channels_ch2, i32 0, i32 %tmp_21_cast
  %in_channels_ch3_addr = getelementptr [2457600 x i8]* %in_channels_ch3, i32 0, i32 %tmp_21_cast
  %out_channels_ch1_add = getelementptr [2457600 x i8]* %out_channels_ch1, i32 0, i32 %tmp_21_cast
  %out_channels_ch2_add = getelementptr [2457600 x i8]* %out_channels_ch2, i32 0, i32 %tmp_21_cast
  %out_channels_ch3_add = getelementptr [2457600 x i8]* %out_channels_ch3, i32 0, i32 %tmp_21_cast
...
; <label>:4                                       ; preds = %3
  ...
  %tmp_24_cast = zext i23 %tmp_24 to i32
  %in_channels_ch1_addr = getelementptr [2457600 x i8]* %in_channels_ch1, i32 0, i32 %tmp_24_cast
  %in_channels_ch2_addr = getelementptr [2457600 x i8]* %in_channels_ch2, i32 0, i32 %tmp_24_cast
  %in_channels_ch3_addr = getelementptr [2457600 x i8]* %in_channels_ch3, i32 0, i32 %tmp_24_cast
  %out_channels_ch1_add = getelementptr [2457600 x i8]* %out_channels_ch1, i32 0, i32 %tmp_24_cast
  %out_channels_ch2_add = getelementptr [2457600 x i8]* %out_channels_ch2, i32 0, i32 %tmp_24_cast
  %out_channels_ch3_add = getelementptr [2457600 x i8]* %out_channels_ch3, i32 0, i32 %tmp_24_cast
