; ModuleID = 'C:/Users/User/Desktop/UNI/EmbeddedRealTimeSystem/Assignment2/HLS_labs/lab2/yuv_filter.prj/solution1/.autopilot/db/a.o.2.bc'
...
; <label>:2                                       ; preds = %1
  ...
  %tmp.3.i = zext i16 %x.i to i32, !dbg !222      ; [#uses=6 type=i32] [debug line = 134:2@24:4]
...
; <label>:4                                       ; preds = %3
  ...
  %tmp.5.i = zext i16 %y.i to i32, !dbg !222      ; [#uses=6 type=i32] [debug line = 134:2@24:4]
  %in.channels.ch1.assign.addr = getelementptr [1920 x [1280 x i8]]* %_yuv.channels.ch1, i32 0, i32 %tmp.3.i, i32 %tmp.5.i, !dbg !222 ; [#uses=1 type=i8*] [debug line = 134:2@24:4]
  ...
  %in.channels.ch2.assign.addr = getelementptr [1920 x [1280 x i8]]* %_yuv.channels.ch2, i32 0, i32 %tmp.3.i, i32 %tmp.5.i, !dbg !227 ; [#uses=1 type=i8*] [debug line = 135:10@24:4]
  ...
  %in.channels.ch3.assign.addr = getelementptr [1920 x [1280 x i8]]* %_yuv.channels.ch3, i32 0, i32 %tmp.3.i, i32 %tmp.5.i, !dbg !229 ; [#uses=1 type=i8*] [debug line = 136:10@24:4]
  ...
  %out.channels.ch1.assign.addr = getelementptr [1920 x [1280 x i8]]* %_scale.channels.ch1, i32 0, i32 %tmp.3.i, i32 %tmp.5.i, !dbg !236 ; [#uses=1 type=i8*] [debug line = 140:10@24:4]
  ...
  %out.channels.ch2.assign.addr = getelementptr [1920 x [1280 x i8]]* %_scale.channels.ch2, i32 0, i32 %tmp.3.i, i32 %tmp.5.i, !dbg !237 ; [#uses=1 type=i8*] [debug line = 141:10@24:4]
  ...
  %out.channels.ch3.assign.addr = getelementptr [1920 x [1280 x i8]]* %_scale.channels.ch3, i32 0, i32 %tmp.3.i, i32 %tmp.5.i, !dbg !238 ; [#uses=1 type=i8*] [debug line = 142:10@24:4]
...
; <label>:2                                       ; preds = %1
  ...
  %tmp = zext i16 %x to i32, !dbg !273            ; [#uses=6 type=i32] [debug line = 94:2]
...
_ifconv:                                          ; preds = %3
  ...
  %tmp. = zext i16 %y to i32, !dbg !273           ; [#uses=6 type=i32] [debug line = 94:2]
  %in.channels.ch1.addr = getelementptr [1920 x [1280 x i8]]* %in.channels.ch1, i32 0, i32 %tmp, i32 %tmp., !dbg !273 ; [#uses=1 type=i8*] [debug line = 94:2]
  ...
  %in.channels.ch2.addr = getelementptr [1920 x [1280 x i8]]* %in.channels.ch2, i32 0, i32 %tmp, i32 %tmp., !dbg !280 ; [#uses=1 type=i8*] [debug line = 95:10]
  ...
  %in.channels.ch3.addr = getelementptr [1920 x [1280 x i8]]* %in.channels.ch3, i32 0, i32 %tmp, i32 %tmp., !dbg !282 ; [#uses=1 type=i8*] [debug line = 96:10]
  ...
  %out.channels.ch1.addr = getelementptr [1920 x [1280 x i8]]* %out.channels.ch1, i32 0, i32 %tmp, i32 %tmp., !dbg !296 ; [#uses=1 type=i8*] [debug line = 103:10]
  store i8 %R, i8* %out.channels.ch1.addr, align 1, !dbg !296 ; [debug line = 103:10]
  %out.channels.ch2.addr = getelementptr [1920 x [1280 x i8]]* %out.channels.ch2, i32 0, i32 %tmp, i32 %tmp., !dbg !297 ; [#uses=1 type=i8*] [debug line = 104:10]
  store i8 %G, i8* %out.channels.ch2.addr, align 1, !dbg !297 ; [debug line = 104:10]
  %out.channels.ch3.addr = getelementptr [1920 x [1280 x i8]]* %out.channels.ch3, i32 0, i32 %tmp, i32 %tmp., !dbg !298 ; [#uses=1 type=i8*] [debug line = 105:10]
...
; <label>:2                                       ; preds = %1
  ...
  %tmp = zext i16 %x to i32, !dbg !330            ; [#uses=6 type=i32] [debug line = 54:2]
...
; <label>:4                                       ; preds = %3
  ...
  %tmp. = zext i16 %y to i32, !dbg !330           ; [#uses=6 type=i32] [debug line = 54:2]
  %in.channels.ch1.addr = getelementptr [1920 x [1280 x i8]]* %in.channels.ch1, i32 0, i32 %tmp, i32 %tmp., !dbg !330 ; [#uses=1 type=i8*] [debug line = 54:2]
  ...
  %in.channels.ch2.addr = getelementptr [1920 x [1280 x i8]]* %in.channels.ch2, i32 0, i32 %tmp, i32 %tmp., !dbg !337 ; [#uses=1 type=i8*] [debug line = 55:10]
  ...
  %in.channels.ch3.addr = getelementptr [1920 x [1280 x i8]]* %in.channels.ch3, i32 0, i32 %tmp, i32 %tmp., !dbg !339 ; [#uses=1 type=i8*] [debug line = 56:10]
  ...
  %out.channels.ch1.addr = getelementptr [1920 x [1280 x i8]]* %out.channels.ch1, i32 0, i32 %tmp, i32 %tmp., !dbg !347 ; [#uses=1 type=i8*] [debug line = 60:10]
  store i8 %Y, i8* %out.channels.ch1.addr, align 1, !dbg !347 ; [debug line = 60:10]
  %out.channels.ch2.addr = getelementptr [1920 x [1280 x i8]]* %out.channels.ch2, i32 0, i32 %tmp, i32 %tmp., !dbg !348 ; [#uses=1 type=i8*] [debug line = 61:10]
  store i8 %U, i8* %out.channels.ch2.addr, align 1, !dbg !348 ; [debug line = 61:10]
  %out.channels.ch3.addr = getelementptr [1920 x [1280 x i8]]* %out.channels.ch3, i32 0, i32 %tmp, i32 %tmp., !dbg !349 ; [#uses=1 type=i8*] [debug line = 62:10]
...
!145 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !146} ; [ DW_TAG_pointer_type ]
