; ModuleID = 'C:/Users/User/Desktop/UNI/EmbeddedRealTimeSystem/Assignment2/HLS_labs/lab2/yuv_filter.prj/solution3/.autopilot/db/a.g.bc'
...
define void @yuv_filter(%struct.image_t* %in, %struct.image_t* %out, i8 zeroext %Y_scale, i8 zeroext %U_scale, i8 zeroext %V_scale) nounwind {
  ...
  call void bitcast (void (...)* @_ssdm_op_SpecDataflowPipeline to void (i32, i8*)*)(i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !77 ; [debug line = 12:1]
  ...
  store %struct.image_t* %_yuv, %struct.image_t** %yuv, align 4, !dbg !85 ; [debug line = 19:24]
  call void @llvm.dbg.declare(metadata !{%struct.image_t** %scale}, metadata !86), !dbg !87 ; [debug line = 20:13] [debug variable = scale]
  store %struct.image_t* %_scale, %struct.image_t** %scale, align 4, !dbg !88 ; [debug line = 20:28]
  %6 = load %struct.image_t** %1, align 4, !dbg !89 ; [#uses=1 type=%struct.image_t*] [debug line = 23:4]
  %7 = load %struct.image_t** %yuv, align 4, !dbg !89 ; [#uses=1 type=%struct.image_t*] [debug line = 23:4]
  call void @rgb2yuv(%struct.image_t* %6, %struct.image_t* %7), !dbg !89 ; [debug line = 23:4]
  %8 = load %struct.image_t** %yuv, align 4, !dbg !90 ; [#uses=1 type=%struct.image_t*] [debug line = 24:4]
  %9 = load %struct.image_t** %scale, align 4, !dbg !90 ; [#uses=1 type=%struct.image_t*] [debug line = 24:4]
  ...
  %13 = load %struct.image_t** %scale, align 4, !dbg !91 ; [#uses=1 type=%struct.image_t*] [debug line = 25:4]
  %14 = load %struct.image_t** %2, align 4, !dbg !91 ; [#uses=1 type=%struct.image_t*] [debug line = 25:4]
...
define void @rgb2yuv(%struct.image_t* %in, %struct.image_t* %out) nounwind {
  ...
  call void bitcast (void (...)* @_ssdm_SpecConstant to void ([3 x i16]*)*)([3 x i16]* getelementptr inbounds ([3 x [3 x i16]]* @rgb2yuv.Wrgb, i32 0, i32 0)) nounwind, !dbg !118 ; [debug line = 42:1]
  %3 = load %struct.image_t** %1, align 4, !dbg !119 ; [#uses=1 type=%struct.image_t*] [debug line = 43:4]
  ...
  %6 = load %struct.image_t** %1, align 4, !dbg !120 ; [#uses=1 type=%struct.image_t*] [debug line = 44:4]
  ...
  %10 = load %struct.image_t** %2, align 4, !dbg !121 ; [#uses=1 type=%struct.image_t*] [debug line = 45:4]
  ...
  %13 = load %struct.image_t** %2, align 4, !dbg !122 ; [#uses=1 type=%struct.image_t*] [debug line = 46:4]
...
; <label>:22                                      ; preds = %16
  call void bitcast (void (...)* @_ssdm_op_SpecLoopName to void (i8*)*)(i8* getelementptr inbounds ([15 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !125 ; [debug line = 49:29]
  call void bitcast (void (...)* @_ssdm_RegionBegin to void (i8*)*)(i8* getelementptr inbounds ([15 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !125 ; [debug line = 49:29]
  call void bitcast (void (...)* @_ssdm_op_SpecPipeline to void (i32, i32, i32, i32, i8*)*)(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !127 ; [debug line = 50:1]
  call void bitcast (void (...)* @_ssdm_op_SpecLoopTripCount to void (i32, i32, i32, i8*)*)(i32 200, i32 1920, i32 1060, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !127 ; [debug line = 50:1]
...
; <label>:30                                      ; preds = %24
  call void bitcast (void (...)* @_ssdm_op_SpecLoopName to void (i8*)*)(i8* getelementptr inbounds ([15 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !130 ; [debug line = 52:33]
  call void bitcast (void (...)* @_ssdm_RegionBegin to void (i8*)*)(i8* getelementptr inbounds ([15 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !130 ; [debug line = 52:33]
  call void bitcast (void (...)* @_ssdm_op_SpecLoopTripCount to void (i32, i32, i32, i8*)*)(i32 200, i32 1280, i32 740, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !132 ; [debug line = 53:1]
  %31 = load i16* %y, align 2, !dbg !133          ; [#uses=1 type=i16] [debug line = 54:2]
  %32 = zext i16 %31 to i32, !dbg !133            ; [#uses=1 type=i32] [debug line = 54:2]
  %33 = load i16* %x, align 2, !dbg !133          ; [#uses=1 type=i16] [debug line = 54:2]
  %34 = zext i16 %33 to i32, !dbg !133            ; [#uses=1 type=i32] [debug line = 54:2]
  %35 = load %struct.image_t** %1, align 4, !dbg !133 ; [#uses=1 type=%struct.image_t*] [debug line = 54:2]
  ...
  %38 = getelementptr inbounds [1920 x [1280 x i8]]* %37, i32 0, i32 %34, !dbg !133 ; [#uses=1 type=[1280 x i8]*] [debug line = 54:2]
  %39 = getelementptr inbounds [1280 x i8]* %38, i32 0, i32 %32, !dbg !133 ; [#uses=1 type=i8*] [debug line = 54:2]
  ...
  %42 = zext i16 %41 to i32, !dbg !134            ; [#uses=1 type=i32] [debug line = 55:10]
  %43 = load i16* %x, align 2, !dbg !134          ; [#uses=1 type=i16] [debug line = 55:10]
  %44 = zext i16 %43 to i32, !dbg !134            ; [#uses=1 type=i32] [debug line = 55:10]
  %45 = load %struct.image_t** %1, align 4, !dbg !134 ; [#uses=1 type=%struct.image_t*] [debug line = 55:10]
  ...
  %48 = getelementptr inbounds [1920 x [1280 x i8]]* %47, i32 0, i32 %44, !dbg !134 ; [#uses=1 type=[1280 x i8]*] [debug line = 55:10]
  %49 = getelementptr inbounds [1280 x i8]* %48, i32 0, i32 %42, !dbg !134 ; [#uses=1 type=i8*] [debug line = 55:10]
  ...
  %52 = zext i16 %51 to i32, !dbg !135            ; [#uses=1 type=i32] [debug line = 56:10]
  %53 = load i16* %x, align 2, !dbg !135          ; [#uses=1 type=i16] [debug line = 56:10]
  %54 = zext i16 %53 to i32, !dbg !135            ; [#uses=1 type=i32] [debug line = 56:10]
  %55 = load %struct.image_t** %1, align 4, !dbg !135 ; [#uses=1 type=%struct.image_t*] [debug line = 56:10]
  ...
  %58 = getelementptr inbounds [1920 x [1280 x i8]]* %57, i32 0, i32 %54, !dbg !135 ; [#uses=1 type=[1280 x i8]*] [debug line = 56:10]
  %59 = getelementptr inbounds [1280 x i8]* %58, i32 0, i32 %52, !dbg !135 ; [#uses=1 type=i8*] [debug line = 56:10]
  %60 = load i8* %59, align 1, !dbg !135          ; [#uses=1 type=i8] [debug line = 56:10]
  store i8 %60, i8* %B, align 1, !dbg !135        ; [debug line = 56:10]
  %61 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @rgb2yuv.Wrgb, i32 0, i32 0, i32 0), align 2, !dbg !136 ; [#uses=1 type=i16] [debug line = 57:10]
  ...
  %66 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @rgb2yuv.Wrgb, i32 0, i32 0, i32 1), align 2, !dbg !136 ; [#uses=1 type=i16] [debug line = 57:10]
  ...
  %72 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @rgb2yuv.Wrgb, i32 0, i32 0, i32 2), align 2, !dbg !136 ; [#uses=1 type=i16] [debug line = 57:10]
  ...
  %82 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @rgb2yuv.Wrgb, i32 0, i32 1, i32 0), align 2, !dbg !137 ; [#uses=1 type=i16] [debug line = 58:10]
  ...
  %87 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @rgb2yuv.Wrgb, i32 0, i32 1, i32 1), align 2, !dbg !137 ; [#uses=1 type=i16] [debug line = 58:10]
  ...
  %93 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @rgb2yuv.Wrgb, i32 0, i32 1, i32 2), align 2, !dbg !137 ; [#uses=1 type=i16] [debug line = 58:10]
  ...
  %103 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @rgb2yuv.Wrgb, i32 0, i32 2, i32 0), align 2, !dbg !138 ; [#uses=1 type=i16] [debug line = 59:10]
  ...
  %108 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @rgb2yuv.Wrgb, i32 0, i32 2, i32 1), align 2, !dbg !138 ; [#uses=1 type=i16] [debug line = 59:10]
  ...
  %114 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @rgb2yuv.Wrgb, i32 0, i32 2, i32 2), align 2, !dbg !138 ; [#uses=1 type=i16] [debug line = 59:10]
  ...
  %126 = zext i16 %125 to i32, !dbg !139          ; [#uses=1 type=i32] [debug line = 60:10]
  %127 = load i16* %x, align 2, !dbg !139         ; [#uses=1 type=i16] [debug line = 60:10]
  %128 = zext i16 %127 to i32, !dbg !139          ; [#uses=1 type=i32] [debug line = 60:10]
  %129 = load %struct.image_t** %2, align 4, !dbg !139 ; [#uses=1 type=%struct.image_t*] [debug line = 60:10]
  ...
  %132 = getelementptr inbounds [1920 x [1280 x i8]]* %131, i32 0, i32 %128, !dbg !139 ; [#uses=1 type=[1280 x i8]*] [debug line = 60:10]
  %133 = getelementptr inbounds [1280 x i8]* %132, i32 0, i32 %126, !dbg !139 ; [#uses=1 type=i8*] [debug line = 60:10]
  ...
  %136 = zext i16 %135 to i32, !dbg !140          ; [#uses=1 type=i32] [debug line = 61:10]
  %137 = load i16* %x, align 2, !dbg !140         ; [#uses=1 type=i16] [debug line = 61:10]
  %138 = zext i16 %137 to i32, !dbg !140          ; [#uses=1 type=i32] [debug line = 61:10]
  %139 = load %struct.image_t** %2, align 4, !dbg !140 ; [#uses=1 type=%struct.image_t*] [debug line = 61:10]
  ...
  %142 = getelementptr inbounds [1920 x [1280 x i8]]* %141, i32 0, i32 %138, !dbg !140 ; [#uses=1 type=[1280 x i8]*] [debug line = 61:10]
  %143 = getelementptr inbounds [1280 x i8]* %142, i32 0, i32 %136, !dbg !140 ; [#uses=1 type=i8*] [debug line = 61:10]
  ...
  %146 = zext i16 %145 to i32, !dbg !141          ; [#uses=1 type=i32] [debug line = 62:10]
  %147 = load i16* %x, align 2, !dbg !141         ; [#uses=1 type=i16] [debug line = 62:10]
  %148 = zext i16 %147 to i32, !dbg !141          ; [#uses=1 type=i32] [debug line = 62:10]
  %149 = load %struct.image_t** %2, align 4, !dbg !141 ; [#uses=1 type=%struct.image_t*] [debug line = 62:10]
  ...
  %152 = getelementptr inbounds [1920 x [1280 x i8]]* %151, i32 0, i32 %148, !dbg !141 ; [#uses=1 type=[1280 x i8]*] [debug line = 62:10]
  %153 = getelementptr inbounds [1280 x i8]* %152, i32 0, i32 %146, !dbg !141 ; [#uses=1 type=i8*] [debug line = 62:10]
  store i8 %144, i8* %153, align 1, !dbg !141     ; [debug line = 62:10]
  call void bitcast (void (...)* @_ssdm_RegionEnd to void (i8*)*)(i8* getelementptr inbounds ([15 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !142 ; [debug line = 63:7]
...
; <label>:157                                     ; preds = %24
  call void bitcast (void (...)* @_ssdm_RegionEnd to void (i8*)*)(i8* getelementptr inbounds ([15 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !144 ; [debug line = 64:4]
...
define void @yuv_scale(%struct.image_t* %in, %struct.image_t* %out, i8 zeroext %Y_scale, i8 zeroext %U_scale, i8 zeroext %V_scale) nounwind {
  ...
  call void bitcast (void (...)* @_ssdm_InlineSelf to void (i32, i8*)*)(i32 2, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !157 ; [debug line = 118:1]
  ...
  %6 = load %struct.image_t** %1, align 4, !dbg !180 ; [#uses=1 type=%struct.image_t*] [debug line = 123:4]
  ...
  %9 = load %struct.image_t** %1, align 4, !dbg !181 ; [#uses=1 type=%struct.image_t*] [debug line = 124:4]
  ...
  %13 = load %struct.image_t** %2, align 4, !dbg !182 ; [#uses=1 type=%struct.image_t*] [debug line = 125:4]
  ...
  %16 = load %struct.image_t** %2, align 4, !dbg !183 ; [#uses=1 type=%struct.image_t*] [debug line = 126:4]
...
; <label>:25                                      ; preds = %19
  call void bitcast (void (...)* @_ssdm_op_SpecLoopName to void (i8*)*)(i8* getelementptr inbounds ([17 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !186 ; [debug line = 129:29]
  call void bitcast (void (...)* @_ssdm_RegionBegin to void (i8*)*)(i8* getelementptr inbounds ([17 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !186 ; [debug line = 129:29]
  call void bitcast (void (...)* @_ssdm_op_SpecLoopTripCount to void (i32, i32, i32, i8*)*)(i32 200, i32 1920, i32 1060, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !188 ; [debug line = 130:1]
...
; <label>:33                                      ; preds = %27
  call void bitcast (void (...)* @_ssdm_op_SpecLoopName to void (i8*)*)(i8* getelementptr inbounds ([17 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !191 ; [debug line = 132:33]
  call void bitcast (void (...)* @_ssdm_RegionBegin to void (i8*)*)(i8* getelementptr inbounds ([17 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !191 ; [debug line = 132:33]
  call void bitcast (void (...)* @_ssdm_op_SpecPipeline to void (i32, i32, i32, i32, i8*)*)(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !193 ; [debug line = 133:1]
  call void bitcast (void (...)* @_ssdm_op_SpecLoopTripCount to void (i32, i32, i32, i8*)*)(i32 200, i32 1280, i32 740, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !193 ; [debug line = 133:1]
  %34 = load i16* %y, align 2, !dbg !194          ; [#uses=1 type=i16] [debug line = 134:2]
  %35 = zext i16 %34 to i32, !dbg !194            ; [#uses=1 type=i32] [debug line = 134:2]
  %36 = load i16* %x, align 2, !dbg !194          ; [#uses=1 type=i16] [debug line = 134:2]
  %37 = zext i16 %36 to i32, !dbg !194            ; [#uses=1 type=i32] [debug line = 134:2]
  %38 = load %struct.image_t** %1, align 4, !dbg !194 ; [#uses=1 type=%struct.image_t*] [debug line = 134:2]
  ...
  %41 = getelementptr inbounds [1920 x [1280 x i8]]* %40, i32 0, i32 %37, !dbg !194 ; [#uses=1 type=[1280 x i8]*] [debug line = 134:2]
  %42 = getelementptr inbounds [1280 x i8]* %41, i32 0, i32 %35, !dbg !194 ; [#uses=1 type=i8*] [debug line = 134:2]
  ...
  %45 = zext i16 %44 to i32, !dbg !195            ; [#uses=1 type=i32] [debug line = 135:10]
  %46 = load i16* %x, align 2, !dbg !195          ; [#uses=1 type=i16] [debug line = 135:10]
  %47 = zext i16 %46 to i32, !dbg !195            ; [#uses=1 type=i32] [debug line = 135:10]
  %48 = load %struct.image_t** %1, align 4, !dbg !195 ; [#uses=1 type=%struct.image_t*] [debug line = 135:10]
  ...
  %51 = getelementptr inbounds [1920 x [1280 x i8]]* %50, i32 0, i32 %47, !dbg !195 ; [#uses=1 type=[1280 x i8]*] [debug line = 135:10]
  %52 = getelementptr inbounds [1280 x i8]* %51, i32 0, i32 %45, !dbg !195 ; [#uses=1 type=i8*] [debug line = 135:10]
  ...
  %55 = zext i16 %54 to i32, !dbg !196            ; [#uses=1 type=i32] [debug line = 136:10]
  %56 = load i16* %x, align 2, !dbg !196          ; [#uses=1 type=i16] [debug line = 136:10]
  %57 = zext i16 %56 to i32, !dbg !196            ; [#uses=1 type=i32] [debug line = 136:10]
  %58 = load %struct.image_t** %1, align 4, !dbg !196 ; [#uses=1 type=%struct.image_t*] [debug line = 136:10]
  ...
  %61 = getelementptr inbounds [1920 x [1280 x i8]]* %60, i32 0, i32 %57, !dbg !196 ; [#uses=1 type=[1280 x i8]*] [debug line = 136:10]
  %62 = getelementptr inbounds [1280 x i8]* %61, i32 0, i32 %55, !dbg !196 ; [#uses=1 type=i8*] [debug line = 136:10]
  ...
  %88 = zext i16 %87 to i32, !dbg !200            ; [#uses=1 type=i32] [debug line = 140:10]
  %89 = load i16* %x, align 2, !dbg !200          ; [#uses=1 type=i16] [debug line = 140:10]
  %90 = zext i16 %89 to i32, !dbg !200            ; [#uses=1 type=i32] [debug line = 140:10]
  %91 = load %struct.image_t** %2, align 4, !dbg !200 ; [#uses=1 type=%struct.image_t*] [debug line = 140:10]
  ...
  %94 = getelementptr inbounds [1920 x [1280 x i8]]* %93, i32 0, i32 %90, !dbg !200 ; [#uses=1 type=[1280 x i8]*] [debug line = 140:10]
  %95 = getelementptr inbounds [1280 x i8]* %94, i32 0, i32 %88, !dbg !200 ; [#uses=1 type=i8*] [debug line = 140:10]
  ...
  %99 = zext i16 %98 to i32, !dbg !201            ; [#uses=1 type=i32] [debug line = 141:10]
  %100 = load i16* %x, align 2, !dbg !201         ; [#uses=1 type=i16] [debug line = 141:10]
  %101 = zext i16 %100 to i32, !dbg !201          ; [#uses=1 type=i32] [debug line = 141:10]
  %102 = load %struct.image_t** %2, align 4, !dbg !201 ; [#uses=1 type=%struct.image_t*] [debug line = 141:10]
  ...
  %105 = getelementptr inbounds [1920 x [1280 x i8]]* %104, i32 0, i32 %101, !dbg !201 ; [#uses=1 type=[1280 x i8]*] [debug line = 141:10]
  %106 = getelementptr inbounds [1280 x i8]* %105, i32 0, i32 %99, !dbg !201 ; [#uses=1 type=i8*] [debug line = 141:10]
  ...
  %110 = zext i16 %109 to i32, !dbg !202          ; [#uses=1 type=i32] [debug line = 142:10]
  %111 = load i16* %x, align 2, !dbg !202         ; [#uses=1 type=i16] [debug line = 142:10]
  %112 = zext i16 %111 to i32, !dbg !202          ; [#uses=1 type=i32] [debug line = 142:10]
  %113 = load %struct.image_t** %2, align 4, !dbg !202 ; [#uses=1 type=%struct.image_t*] [debug line = 142:10]
  ...
  %116 = getelementptr inbounds [1920 x [1280 x i8]]* %115, i32 0, i32 %112, !dbg !202 ; [#uses=1 type=[1280 x i8]*] [debug line = 142:10]
  %117 = getelementptr inbounds [1280 x i8]* %116, i32 0, i32 %110, !dbg !202 ; [#uses=1 type=i8*] [debug line = 142:10]
  store i8 %108, i8* %117, align 1, !dbg !202     ; [debug line = 142:10]
  call void bitcast (void (...)* @_ssdm_RegionEnd to void (i8*)*)(i8* getelementptr inbounds ([17 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !203 ; [debug line = 143:7]
...
; <label>:121                                     ; preds = %27
  call void bitcast (void (...)* @_ssdm_RegionEnd to void (i8*)*)(i8* getelementptr inbounds ([17 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !205 ; [debug line = 144:4]
...
define void @yuv2rgb(%struct.image_t* %in, %struct.image_t* %out) nounwind {
  ...
  call void bitcast (void (...)* @_ssdm_SpecConstant to void ([3 x i16]*)*)([3 x i16]* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 0)) nounwind, !dbg !239 ; [debug line = 82:1]
  %3 = load %struct.image_t** %1, align 4, !dbg !240 ; [#uses=1 type=%struct.image_t*] [debug line = 83:4]
  ...
  %6 = load %struct.image_t** %1, align 4, !dbg !241 ; [#uses=1 type=%struct.image_t*] [debug line = 84:4]
  ...
  %10 = load %struct.image_t** %2, align 4, !dbg !242 ; [#uses=1 type=%struct.image_t*] [debug line = 85:4]
  ...
  %13 = load %struct.image_t** %2, align 4, !dbg !243 ; [#uses=1 type=%struct.image_t*] [debug line = 86:4]
...
; <label>:22                                      ; preds = %16
  call void bitcast (void (...)* @_ssdm_op_SpecLoopName to void (i8*)*)(i8* getelementptr inbounds ([15 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !246 ; [debug line = 89:29]
  call void bitcast (void (...)* @_ssdm_RegionBegin to void (i8*)*)(i8* getelementptr inbounds ([15 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !246 ; [debug line = 89:29]
  call void bitcast (void (...)* @_ssdm_op_SpecPipeline to void (i32, i32, i32, i32, i8*)*)(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !248 ; [debug line = 90:1]
  call void bitcast (void (...)* @_ssdm_op_SpecLoopTripCount to void (i32, i32, i32, i8*)*)(i32 200, i32 1920, i32 1060, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !248 ; [debug line = 90:1]
...
; <label>:30                                      ; preds = %24
  call void bitcast (void (...)* @_ssdm_op_SpecLoopName to void (i8*)*)(i8* getelementptr inbounds ([15 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !251 ; [debug line = 92:33]
  call void bitcast (void (...)* @_ssdm_RegionBegin to void (i8*)*)(i8* getelementptr inbounds ([15 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !251 ; [debug line = 92:33]
  call void bitcast (void (...)* @_ssdm_op_SpecLoopTripCount to void (i32, i32, i32, i8*)*)(i32 200, i32 1280, i32 740, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !253 ; [debug line = 93:1]
  %31 = load i16* %y, align 2, !dbg !254          ; [#uses=1 type=i16] [debug line = 94:2]
  %32 = zext i16 %31 to i32, !dbg !254            ; [#uses=1 type=i32] [debug line = 94:2]
  %33 = load i16* %x, align 2, !dbg !254          ; [#uses=1 type=i16] [debug line = 94:2]
  %34 = zext i16 %33 to i32, !dbg !254            ; [#uses=1 type=i32] [debug line = 94:2]
  %35 = load %struct.image_t** %1, align 4, !dbg !254 ; [#uses=1 type=%struct.image_t*] [debug line = 94:2]
  ...
  %38 = getelementptr inbounds [1920 x [1280 x i8]]* %37, i32 0, i32 %34, !dbg !254 ; [#uses=1 type=[1280 x i8]*] [debug line = 94:2]
  %39 = getelementptr inbounds [1280 x i8]* %38, i32 0, i32 %32, !dbg !254 ; [#uses=1 type=i8*] [debug line = 94:2]
  ...
  %42 = zext i16 %41 to i32, !dbg !255            ; [#uses=1 type=i32] [debug line = 95:10]
  %43 = load i16* %x, align 2, !dbg !255          ; [#uses=1 type=i16] [debug line = 95:10]
  %44 = zext i16 %43 to i32, !dbg !255            ; [#uses=1 type=i32] [debug line = 95:10]
  %45 = load %struct.image_t** %1, align 4, !dbg !255 ; [#uses=1 type=%struct.image_t*] [debug line = 95:10]
  ...
  %48 = getelementptr inbounds [1920 x [1280 x i8]]* %47, i32 0, i32 %44, !dbg !255 ; [#uses=1 type=[1280 x i8]*] [debug line = 95:10]
  %49 = getelementptr inbounds [1280 x i8]* %48, i32 0, i32 %42, !dbg !255 ; [#uses=1 type=i8*] [debug line = 95:10]
  ...
  %52 = zext i16 %51 to i32, !dbg !256            ; [#uses=1 type=i32] [debug line = 96:10]
  %53 = load i16* %x, align 2, !dbg !256          ; [#uses=1 type=i16] [debug line = 96:10]
  %54 = zext i16 %53 to i32, !dbg !256            ; [#uses=1 type=i32] [debug line = 96:10]
  %55 = load %struct.image_t** %1, align 4, !dbg !256 ; [#uses=1 type=%struct.image_t*] [debug line = 96:10]
  ...
  %58 = getelementptr inbounds [1920 x [1280 x i8]]* %57, i32 0, i32 %54, !dbg !256 ; [#uses=1 type=[1280 x i8]*] [debug line = 96:10]
  %59 = getelementptr inbounds [1280 x i8]* %58, i32 0, i32 %52, !dbg !256 ; [#uses=1 type=i8*] [debug line = 96:10]
  ...
  %73 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 0, i32 0), align 2, !dbg !260 ; [#uses=1 type=i16] [debug line = 100:10]
  ...
  %78 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 0, i32 2), align 2, !dbg !260 ; [#uses=1 type=i16] [debug line = 100:10]
...
; <label>:88                                      ; preds = %30
  %89 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 0, i32 0), align 2, !dbg !260 ; [#uses=1 type=i16] [debug line = 100:10]
  ...
  %94 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 0, i32 2), align 2, !dbg !260 ; [#uses=1 type=i16] [debug line = 100:10]
...
; <label>:104                                     ; preds = %88
  %105 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 0, i32 0), align 2, !dbg !260 ; [#uses=1 type=i16] [debug line = 100:10]
  ...
  %110 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 0, i32 2), align 2, !dbg !260 ; [#uses=1 type=i16] [debug line = 100:10]
...
; <label>:120                                     ; preds = %118, %87
  ...
  %123 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 1, i32 0), align 2, !dbg !261 ; [#uses=1 type=i16] [debug line = 101:10]
  ...
  %128 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 1, i32 1), align 2, !dbg !261 ; [#uses=1 type=i16] [debug line = 101:10]
  ...
  %134 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 1, i32 2), align 2, !dbg !261 ; [#uses=1 type=i16] [debug line = 101:10]
...
; <label>:144                                     ; preds = %120
  %145 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 1, i32 0), align 2, !dbg !261 ; [#uses=1 type=i16] [debug line = 101:10]
  ...
  %150 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 1, i32 1), align 2, !dbg !261 ; [#uses=1 type=i16] [debug line = 101:10]
  ...
  %156 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 1, i32 2), align 2, !dbg !261 ; [#uses=1 type=i16] [debug line = 101:10]
...
; <label>:166                                     ; preds = %144
  %167 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 1, i32 0), align 2, !dbg !261 ; [#uses=1 type=i16] [debug line = 101:10]
  ...
  %172 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 1, i32 1), align 2, !dbg !261 ; [#uses=1 type=i16] [debug line = 101:10]
  ...
  %178 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 1, i32 2), align 2, !dbg !261 ; [#uses=1 type=i16] [debug line = 101:10]
...
; <label>:188                                     ; preds = %186, %143
  ...
  %191 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 2, i32 0), align 2, !dbg !262 ; [#uses=1 type=i16] [debug line = 102:10]
  ...
  %196 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 2, i32 1), align 2, !dbg !262 ; [#uses=1 type=i16] [debug line = 102:10]
...
; <label>:206                                     ; preds = %188
  %207 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 2, i32 0), align 2, !dbg !262 ; [#uses=1 type=i16] [debug line = 102:10]
  ...
  %212 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 2, i32 1), align 2, !dbg !262 ; [#uses=1 type=i16] [debug line = 102:10]
...
; <label>:222                                     ; preds = %206
  %223 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 2, i32 0), align 2, !dbg !262 ; [#uses=1 type=i16] [debug line = 102:10]
  ...
  %228 = load i16* getelementptr inbounds ([3 x [3 x i16]]* @yuv2rgb.Wyuv, i32 0, i32 2, i32 1), align 2, !dbg !262 ; [#uses=1 type=i16] [debug line = 102:10]
...
; <label>:238                                     ; preds = %236, %205
  ...
  %243 = zext i16 %242 to i32, !dbg !263          ; [#uses=1 type=i32] [debug line = 103:10]
  %244 = load i16* %x, align 2, !dbg !263         ; [#uses=1 type=i16] [debug line = 103:10]
  %245 = zext i16 %244 to i32, !dbg !263          ; [#uses=1 type=i32] [debug line = 103:10]
  %246 = load %struct.image_t** %2, align 4, !dbg !263 ; [#uses=1 type=%struct.image_t*] [debug line = 103:10]
  ...
  %249 = getelementptr inbounds [1920 x [1280 x i8]]* %248, i32 0, i32 %245, !dbg !263 ; [#uses=1 type=[1280 x i8]*] [debug line = 103:10]
  %250 = getelementptr inbounds [1280 x i8]* %249, i32 0, i32 %243, !dbg !263 ; [#uses=1 type=i8*] [debug line = 103:10]
  ...
  %253 = zext i16 %252 to i32, !dbg !264          ; [#uses=1 type=i32] [debug line = 104:10]
  %254 = load i16* %x, align 2, !dbg !264         ; [#uses=1 type=i16] [debug line = 104:10]
  %255 = zext i16 %254 to i32, !dbg !264          ; [#uses=1 type=i32] [debug line = 104:10]
  %256 = load %struct.image_t** %2, align 4, !dbg !264 ; [#uses=1 type=%struct.image_t*] [debug line = 104:10]
  ...
  %259 = getelementptr inbounds [1920 x [1280 x i8]]* %258, i32 0, i32 %255, !dbg !264 ; [#uses=1 type=[1280 x i8]*] [debug line = 104:10]
  %260 = getelementptr inbounds [1280 x i8]* %259, i32 0, i32 %253, !dbg !264 ; [#uses=1 type=i8*] [debug line = 104:10]
  ...
  %263 = zext i16 %262 to i32, !dbg !265          ; [#uses=1 type=i32] [debug line = 105:10]
  %264 = load i16* %x, align 2, !dbg !265         ; [#uses=1 type=i16] [debug line = 105:10]
  %265 = zext i16 %264 to i32, !dbg !265          ; [#uses=1 type=i32] [debug line = 105:10]
  %266 = load %struct.image_t** %2, align 4, !dbg !265 ; [#uses=1 type=%struct.image_t*] [debug line = 105:10]
  ...
  %269 = getelementptr inbounds [1920 x [1280 x i8]]* %268, i32 0, i32 %265, !dbg !265 ; [#uses=1 type=[1280 x i8]*] [debug line = 105:10]
  %270 = getelementptr inbounds [1280 x i8]* %269, i32 0, i32 %263, !dbg !265 ; [#uses=1 type=i8*] [debug line = 105:10]
  store i8 %261, i8* %270, align 1, !dbg !265     ; [debug line = 105:10]
  call void bitcast (void (...)* @_ssdm_RegionEnd to void (i8*)*)(i8* getelementptr inbounds ([15 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !266 ; [debug line = 106:7]
...
; <label>:274                                     ; preds = %24
  call void bitcast (void (...)* @_ssdm_RegionEnd to void (i8*)*)(i8* getelementptr inbounds ([15 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !268 ; [debug line = 107:4]
...
!0 = metadata !{i32 786449, i32 0, i32 1, metadata !"C:/Users/User/Desktop/UNI/EmbeddedRealTimeSystem/Assignment2/HLS_labs/lab2/yuv_filter.prj/solution3/.autopilot/db/yuv_filter.pragma.2.c", metadata !"C:\5CUsers\5CUser\5CDesktop\5CUNI\5CEmbeddedRealTimeSystem\5CAssignment2\5CHLS_labs\5Clab2", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !1, metadata !3, metadata !39} ; [ DW_TAG_compile_unit ]
