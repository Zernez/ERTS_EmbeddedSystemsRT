...
; <label>:7                                       ; preds = %6
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str) nounwind, !dbg !278 ; [debug line = 90:1]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 200, i32 1920, i32 1060, [1 x i8]* @.str) nounwind, !dbg !278 ; [debug line = 90:1]
  %tmp = zext i16 %x to i32, !dbg !279            ; [#uses=3 type=i32] [debug line = 94:2]
...
_ifconv:                                          ; preds = %8
  ...
  %tmp. = zext i16 %y to i32, !dbg !279           ; [#uses=3 type=i32] [debug line = 94:2]
  ...
  %out.channels.ch1.addr = getelementptr [1920 x [1280 x i8]]* %out.channels.ch1, i32 0, i32 %tmp, i32 %tmp., !dbg !302 ; [#uses=1 type=i8*] [debug line = 103:10]
  store i8 %R, i8* %out.channels.ch1.addr, align 1, !dbg !302 ; [debug line = 103:10]
  %out.channels.ch2.addr = getelementptr [1920 x [1280 x i8]]* %out.channels.ch2, i32 0, i32 %tmp, i32 %tmp., !dbg !303 ; [#uses=1 type=i8*] [debug line = 104:10]
  store i8 %G, i8* %out.channels.ch2.addr, align 1, !dbg !303 ; [debug line = 104:10]
  %out.channels.ch3.addr = getelementptr [1920 x [1280 x i8]]* %out.channels.ch3, i32 0, i32 %tmp, i32 %tmp., !dbg !304 ; [#uses=1 type=i8*] [debug line = 105:10]
...
; <label>:9                                       ; preds = %8
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str) nounwind, !dbg !337 ; [debug line = 50:1]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 200, i32 1920, i32 1060, [1 x i8]* @.str) nounwind, !dbg !337 ; [debug line = 50:1]
  %tmp.i.i = zext i16 %x.i.i to i32, !dbg !338    ; [#uses=3 type=i32] [debug line = 54:2]
...
; <label>:11                                      ; preds = %10
  ...
  %tmp..i.i = zext i16 %y.i.i to i32, !dbg !338   ; [#uses=3 type=i32] [debug line = 54:2]
  %in.channels.ch1.addr = getelementptr [1920 x [1280 x i8]]* %in.channels.ch1, i32 0, i32 %tmp.i.i, i32 %tmp..i.i, !dbg !338 ; [#uses=1 type=i8*] [debug line = 54:2]
  ...
  %in.channels.ch2.addr = getelementptr [1920 x [1280 x i8]]* %in.channels.ch2, i32 0, i32 %tmp.i.i, i32 %tmp..i.i, !dbg !345 ; [#uses=1 type=i8*] [debug line = 55:10]
  ...
  %in.channels.ch3.addr = getelementptr [1920 x [1280 x i8]]* %in.channels.ch3, i32 0, i32 %tmp.i.i, i32 %tmp..i.i, !dbg !347 ; [#uses=1 type=i8*] [debug line = 56:10]
