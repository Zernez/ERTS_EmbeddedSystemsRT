; ModuleID = 'C:/Users/User/Desktop/UNI/EmbeddedRealTimeSystem/Assignment2/HLS_labs/lab2/yuv_filter.prj/solution3/.autopilot/db/a.o.2.bc'
...
.reset:                                           ; preds = %1
  ...
  %tmp_15_cast = zext i23 %tmp_s to i32
  %out_channels_ch1_add = getelementptr [2457600 x i8]* %out_channels_ch1, i32 0, i32 %tmp_15_cast
  %out_channels_ch2_add = getelementptr [2457600 x i8]* %out_channels_ch2, i32 0, i32 %tmp_15_cast
  %out_channels_ch3_add = getelementptr [2457600 x i8]* %out_channels_ch3, i32 0, i32 %tmp_15_cast
  %Y = call i8 @_ssdm_op_Read.ap_fifo.volatile.i8P(i8* %in_channels_ch1)
  %U = call i8 @_ssdm_op_Read.ap_fifo.volatile.i8P(i8* %in_channels_ch2)
  %V = call i8 @_ssdm_op_Read.ap_fifo.volatile.i8P(i8* %in_channels_ch3)
  ...
  %tmp_2 = call i2 @_ssdm_op_PartSelect.i2.i18.i32.i32(i18 %tmp_6, i32 16, i32 17)
  %icmp = icmp eq i2 %tmp_2, 1
  %tmp_8 = call i1 @_ssdm_op_BitSelect.i1.i18.i32(i18 %tmp_6, i32 17)
  %phitmp = call i8 @_ssdm_op_PartSelect.i8.i18.i32.i32(i18 %tmp_6, i32 8, i32 15)
  %p_phitmp = select i1 %icmp, i8 -1, i8 0
  %tmp_9 = or i1 %icmp, %tmp_8
  %R = select i1 %tmp_9, i8 %p_phitmp, i8 %phitmp
  %tmp_26_cast3_cast = sext i8 %D to i16
  %tmp_10 = mul i16 -100, %tmp_26_cast3_cast
  %tmp_11_cast = sext i16 %tmp_10 to i17
  %tmp_11 = mul i17 -208, %tmp_18_cast4_cast
  %tmp1 = add i17 %tmp_11_cast, %tmp_11
  %tmp1_cast = sext i17 %tmp1 to i18
  %tmp_12 = add i18 %tmp1_cast, %tmp_5
  %tmp_13 = call i2 @_ssdm_op_PartSelect.i2.i18.i32.i32(i18 %tmp_12, i32 16, i32 17)
  %icmp1 = icmp eq i2 %tmp_13, 1
  %tmp_14 = call i1 @_ssdm_op_BitSelect.i1.i18.i32(i18 %tmp_12, i32 17)
  %phitmp2 = call i8 @_ssdm_op_PartSelect.i8.i18.i32.i32(i18 %tmp_12, i32 8, i32 15)
  %p_phitmp2 = select i1 %icmp1, i8 -1, i8 0
  %tmp_15 = or i1 %icmp1, %tmp_14
  %G = select i1 %tmp_15, i8 %p_phitmp2, i8 %phitmp2
  ...
  %tmp_16 = add i18 %p_shl_cast, %p_shl1_cast
  %tmp_35_cast = sext i18 %tmp_16 to i19
  %tmp_17 = add i18 %tmp_16, %tmp_5
  %tmp_18 = add i19 %tmp_20_cast, %tmp_35_cast
  ...
  %phitmp3 = call i8 @_ssdm_op_PartSelect.i8.i18.i32.i32(i18 %tmp_17, i32 8, i32 15)
  %p_phitmp3 = select i1 %icmp2, i8 -1, i8 0
  %tmp_21 = or i1 %icmp2, %tmp_20
...
entry:
  %empty = call i32 (...)* @_ssdm_op_SpecInterface(i16* %out_height, [8 x i8]* @ap_fifo_str, i32 0, i32 0, [1 x i8]* @p_str, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str, i32 2, i32 2, i32 16, i32 16, [1 x i8]* @p_str, [1 x i8]* @p_str)
  %empty_71 = call i32 (...)* @_ssdm_op_SpecInterface(i16* %out_width, [8 x i8]* @ap_fifo_str, i32 0, i32 0, [1 x i8]* @p_str, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str, i32 2, i32 2, i32 16, i32 16, [1 x i8]* @p_str, [1 x i8]* @p_str)
  %empty_72 = call i32 (...)* @_ssdm_op_SpecInterface(i8* %out_channels_ch3, [8 x i8]* @ap_fifo_str, i32 0, i32 0, [1 x i8]* @p_str, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str, i32 2, i32 2, i32 16, i32 16, [1 x i8]* @p_str, [1 x i8]* @p_str)
  %empty_73 = call i32 (...)* @_ssdm_op_SpecInterface(i8* %out_channels_ch2, [8 x i8]* @ap_fifo_str, i32 0, i32 0, [1 x i8]* @p_str, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str, i32 2, i32 2, i32 16, i32 16, [1 x i8]* @p_str, [1 x i8]* @p_str)
  %empty_74 = call i32 (...)* @_ssdm_op_SpecInterface(i8* %out_channels_ch1, [8 x i8]* @ap_fifo_str, i32 0, i32 0, [1 x i8]* @p_str, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str, i32 2, i32 2, i32 16, i32 16, [1 x i8]* @p_str, [1 x i8]* @p_str)
  %empty_75 = call i32 (...)* @_ssdm_op_SpecInterface(i8* %Y_scale_out, [8 x i8]* @ap_fifo_str, i32 0, i32 0, [1 x i8]* @p_str, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str, i32 2, i32 2, i32 16, i32 16, [1 x i8]* @p_str, [1 x i8]* @p_str)
  %V_scale_read = call i8 @_ssdm_op_Read.ap_auto.i8(i8 %V_scale)
  %U_scale_read = call i8 @_ssdm_op_Read.ap_auto.i8(i8 %U_scale)
  %Y_scale_read = call i8 @_ssdm_op_Read.ap_auto.i8(i8 %Y_scale)
  call void @_ssdm_op_Write.ap_fifo.i8P(i8* %Y_scale_out, i8 %Y_scale_read)
  %empty_76 = call i32 (...)* @_ssdm_op_SpecInterface(i8* %U_scale_out, [8 x i8]* @ap_fifo_str, i32 0, i32 0, [1 x i8]* @p_str, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str, i32 2, i32 2, i32 16, i32 16, [1 x i8]* @p_str, [1 x i8]* @p_str)
  call void @_ssdm_op_Write.ap_fifo.i8P(i8* %U_scale_out, i8 %U_scale_read)
  %empty_77 = call i32 (...)* @_ssdm_op_SpecInterface(i8* %V_scale_out, [8 x i8]* @ap_fifo_str, i32 0, i32 0, [1 x i8]* @p_str, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str, i32 2, i32 2, i32 16, i32 16, [1 x i8]* @p_str, [1 x i8]* @p_str)
...
.reset:                                           ; preds = %0
  ...
  %tmp_21 = trunc i16 %tmp_i_i_mid2_v to i13
  %p_shl_cast = call i23 @_ssdm_op_BitConcatenate.i23.i13.i10(i13 %tmp_21, i10 0)
  %tmp_22 = trunc i16 %tmp_i_i_mid2_v to i15
  %p_shl1_cast = call i23 @_ssdm_op_BitConcatenate.i23.i15.i8(i15 %tmp_22, i8 0)
  ...
  %tmp_23 = add i23 %tmp_i_i_cast, %tmp_s
  %tmp_26_cast = zext i23 %tmp_23 to i32
  %in_channels_ch1_addr = getelementptr [2457600 x i8]* %in_channels_ch1, i32 0, i32 %tmp_26_cast
  %in_channels_ch2_addr = getelementptr [2457600 x i8]* %in_channels_ch2, i32 0, i32 %tmp_26_cast
  %in_channels_ch3_addr = getelementptr [2457600 x i8]* %in_channels_ch3, i32 0, i32 %tmp_26_cast
...
entry:
  ...
  %empty_78 = trunc i18 %empty to i8
  ret i8 %empty_78
}
...
entry:
  ...
  %empty_79 = trunc i16 %empty to i8
  ret i8 %empty_79
}
...
entry:
  ...
  %empty_80 = trunc i15 %empty to i8
  ret i8 %empty_80
}
...
entry:
  ...
  %empty_81 = trunc i19 %empty to i3
  ret i3 %empty_81
}
...
entry:
  ...
  %empty_82 = trunc i11 %empty to i3
  ret i3 %empty_82
}
...
entry:
  %empty = call i18 @llvm.part.select.i18(i18 %0, i32 %1, i32 %2)
  %empty_83 = trunc i18 %empty to i2
  ret i2 %empty_83
}
...
entry:
  ...
  %empty_84 = trunc i10 %empty to i2
  ret i2 %empty_84
}
...
entry:
  %empty = call i19 @llvm.part.select.i19(i19 %0, i32 %1, i32 %2)
  %empty_85 = trunc i19 %empty to i11
  ret i11 %empty_85
}
...
entry:
  ...
  %empty_87 = shl i19 1, %empty
  %empty_88 = and i19 %0, %empty_87
  %empty_89 = icmp ne i19 %empty_88, 0
  ret i1 %empty_89
}
...
entry:
  ...
  %empty_90 = shl i18 1, %empty
  %empty_91 = and i18 %0, %empty_90
  %empty_92 = icmp ne i18 %empty_91, 0
  ret i1 %empty_92
}
...
entry:
  ...
  %empty_93 = zext i1 %1 to i9
  %empty_94 = shl i9 %empty, 1
...
entry:
  ...
  %empty_96 = zext i8 %1 to i23
  %empty_97 = shl i23 %empty, 8
...
entry:
  ...
  %empty_99 = zext i10 %1 to i23
  %empty_100 = shl i23 %empty, 10
...
entry:
  ...
  %empty_102 = zext i9 %1 to i17
  %empty_103 = shl i17 %empty, 9
  %empty_104 = or i17 %empty_103, %empty_102
  ret i17 %empty_104
}
...
entry:
  ...
  %empty_105 = zext i7 %1 to i15
  %empty_106 = shl i15 %empty, 7
  %empty_107 = or i15 %empty_106, %empty_105
  ret i15 %empty_107
}
...
entry:
  ...
  %empty_108 = zext i6 %1 to i14
  %empty_109 = shl i14 %empty, 6
  %empty_110 = or i14 %empty_109, %empty_108
  ret i14 %empty_110
}
...
entry:
  ...
  %empty_111 = zext i4 %1 to i12
  %empty_112 = shl i12 %empty, 4
  %empty_113 = or i12 %empty_112, %empty_111
  ret i12 %empty_113
}
...
entry:
  ...
  %empty_114 = zext i2 %1 to i10
  %empty_115 = shl i10 %empty, 2
  %empty_116 = or i10 %empty_115, %empty_114
  ret i10 %empty_116
}
