; ModuleID = 'C:/Users/User/Desktop/UNI/EmbeddedRealTimeSystem/Assignment2/HLS_labs/lab2/yuv_filter.prj/solution3/.autopilot/db/a.g.1.bc'
...
define internal fastcc void @yuv_scale(%struct.image_t.1* %in, %struct.image_t.1* %out, i8 zeroext %Y_scale, i8 zeroext %U_scale, i8 zeroext %V_scale) nounwind {
  ...
  call void (...)* @_ssdm_InlineSelf(i32 2, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)), !dbg !77 ; [debug line = 118:1]
...
; <label>:2                                       ; preds = %1
  ...
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 200, i32 1920, i32 1060, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)), !dbg !94 ; [debug line = 130:1]
...
; <label>:4                                       ; preds = %3
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)), !dbg !98 ; [debug line = 133:1]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 200, i32 1280, i32 740, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)), !dbg !98 ; [debug line = 133:1]
...
define void @yuv_filter(%struct.image_t.1* %in, %struct.image_t.1* %out, i8 zeroext %Y_scale, i8 zeroext %U_scale, i8 zeroext %V_scale) nounwind {
  ...
  call void (...)* @_ssdm_op_SpecDataflowPipeline(i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)), !dbg !128 ; [debug line = 12:1]
...
define internal fastcc void @yuv2rgb(%struct.image_t.1* %in, %struct.image_t.1* %out) nounwind {
  ...
  %in.addr = getelementptr inbounds %struct.image_t.1* %in, i32 0, i32 1, !dbg !146 ; [#uses=1 type=i16*] [debug line = 83:4]
  ...
  %in.addr.5 = getelementptr inbounds %struct.image_t.1* %in, i32 0, i32 2, !dbg !149 ; [#uses=1 type=i16*] [debug line = 84:4]
  ...
  %out.addr = getelementptr inbounds %struct.image_t.1* %out, i32 0, i32 1, !dbg !151 ; [#uses=1 type=i16*] [debug line = 85:4]
  store i16 %width, i16* %out.addr, align 2, !dbg !151 ; [debug line = 85:4]
  %out.addr.5 = getelementptr inbounds %struct.image_t.1* %out, i32 0, i32 2, !dbg !152 ; [#uses=1 type=i16*] [debug line = 86:4]
...
; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str3, i32 0, i32 0)), !dbg !155 ; [debug line = 89:29]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !155 ; [#uses=1 type=i32] [debug line = 89:29]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)), !dbg !157 ; [debug line = 90:1]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 200, i32 1920, i32 1060, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)), !dbg !157 ; [debug line = 90:1]
  %tmp = zext i16 %x to i32, !dbg !158            ; [#uses=6 type=i32] [debug line = 94:2]
...
; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str4, i32 0, i32 0)), !dbg !162 ; [debug line = 92:33]
  %rbegin9 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !162 ; [#uses=1 type=i32] [debug line = 92:33]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 200, i32 1280, i32 740, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)), !dbg !163 ; [debug line = 93:1]
  %tmp.20 = zext i16 %y to i32, !dbg !158         ; [#uses=6 type=i32] [debug line = 94:2]
  %in.addr.6 = getelementptr inbounds %struct.image_t.1* %in, i32 0, i32 0, i32 0, i32 %tmp, i32 %tmp.20, !dbg !158 ; [#uses=1 type=i8*] [debug line = 94:2]
  ...
  %in.addr.7 = getelementptr inbounds %struct.image_t.1* %in, i32 0, i32 0, i32 1, i32 %tmp, i32 %tmp.20, !dbg !165 ; [#uses=1 type=i8*] [debug line = 95:10]
  ...
  %in.addr.8 = getelementptr inbounds %struct.image_t.1* %in, i32 0, i32 0, i32 2, i32 %tmp, i32 %tmp.20, !dbg !167 ; [#uses=1 type=i8*] [debug line = 96:10]
...
._crit_edge7:                                     ; preds = %10, %9, %._crit_edge5
  ...
  %out.addr.6 = getelementptr inbounds %struct.image_t.1* %out, i32 0, i32 0, i32 0, i32 %tmp, i32 %tmp.20, !dbg !181 ; [#uses=1 type=i8*] [debug line = 103:10]
  store i8 %R, i8* %out.addr.6, align 1, !dbg !181 ; [debug line = 103:10]
  %out.addr.7 = getelementptr inbounds %struct.image_t.1* %out, i32 0, i32 0, i32 1, i32 %tmp, i32 %tmp.20, !dbg !182 ; [#uses=1 type=i8*] [debug line = 104:10]
  store i8 %G, i8* %out.addr.7, align 1, !dbg !182 ; [debug line = 104:10]
  %out.addr.8 = getelementptr inbounds %struct.image_t.1* %out, i32 0, i32 0, i32 2, i32 %tmp, i32 %tmp.20, !dbg !183 ; [#uses=1 type=i8*] [debug line = 105:10]
  store i8 %B, i8* %out.addr.8, align 1, !dbg !183 ; [debug line = 105:10]
  %rend10 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str4, i32 0, i32 0), i32 %rbegin9) nounwind, !dbg !184 ; [#uses=0 type=i32] [debug line = 106:7]
...
; <label>:11                                      ; preds = %3
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str3, i32 0, i32 0), i32 %rbegin) nounwind, !dbg !187 ; [#uses=0 type=i32] [debug line = 107:4]
...
define internal fastcc void @rgb2yuv(%struct.image_t.1* %in, %struct.image_t.1* %out) nounwind {
  ...
  %in.addr = getelementptr inbounds %struct.image_t.1* %in, i32 0, i32 1, !dbg !195 ; [#uses=1 type=i16*] [debug line = 43:4]
  ...
  %in.addr.9 = getelementptr inbounds %struct.image_t.1* %in, i32 0, i32 2, !dbg !198 ; [#uses=1 type=i16*] [debug line = 44:4]
  ...
  %out.addr = getelementptr inbounds %struct.image_t.1* %out, i32 0, i32 1, !dbg !200 ; [#uses=1 type=i16*] [debug line = 45:4]
  store i16 %width, i16* %out.addr, align 2, !dbg !200 ; [debug line = 45:4]
  %out.addr.9 = getelementptr inbounds %struct.image_t.1* %out, i32 0, i32 2, !dbg !201 ; [#uses=1 type=i16*] [debug line = 46:4]
...
; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str1, i32 0, i32 0)), !dbg !204 ; [debug line = 49:29]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !204 ; [#uses=1 type=i32] [debug line = 49:29]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)), !dbg !206 ; [debug line = 50:1]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 200, i32 1920, i32 1060, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)), !dbg !206 ; [debug line = 50:1]
  %tmp = zext i16 %x to i32, !dbg !207            ; [#uses=6 type=i32] [debug line = 54:2]
...
; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str2, i32 0, i32 0)), !dbg !211 ; [debug line = 52:33]
  %rbegin2 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !211 ; [#uses=1 type=i32] [debug line = 52:33]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 200, i32 1280, i32 740, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)), !dbg !212 ; [debug line = 53:1]
  %tmp.57 = zext i16 %y to i32, !dbg !207         ; [#uses=6 type=i32] [debug line = 54:2]
  %in.addr.10 = getelementptr inbounds %struct.image_t.1* %in, i32 0, i32 0, i32 0, i32 %tmp, i32 %tmp.57, !dbg !207 ; [#uses=1 type=i8*] [debug line = 54:2]
  ...
  %in.addr.11 = getelementptr inbounds %struct.image_t.1* %in, i32 0, i32 0, i32 1, i32 %tmp, i32 %tmp.57, !dbg !214 ; [#uses=1 type=i8*] [debug line = 55:10]
  ...
  %in.addr.12 = getelementptr inbounds %struct.image_t.1* %in, i32 0, i32 0, i32 2, i32 %tmp, i32 %tmp.57, !dbg !216 ; [#uses=1 type=i8*] [debug line = 56:10]
  ...
  %out.addr.10 = getelementptr inbounds %struct.image_t.1* %out, i32 0, i32 0, i32 0, i32 %tmp, i32 %tmp.57, !dbg !224 ; [#uses=1 type=i8*] [debug line = 60:10]
  store i8 %Y, i8* %out.addr.10, align 1, !dbg !224 ; [debug line = 60:10]
  %out.addr.11 = getelementptr inbounds %struct.image_t.1* %out, i32 0, i32 0, i32 1, i32 %tmp, i32 %tmp.57, !dbg !225 ; [#uses=1 type=i8*] [debug line = 61:10]
  store i8 %U, i8* %out.addr.11, align 1, !dbg !225 ; [debug line = 61:10]
  %out.addr.12 = getelementptr inbounds %struct.image_t.1* %out, i32 0, i32 0, i32 2, i32 %tmp, i32 %tmp.57, !dbg !226 ; [#uses=1 type=i8*] [debug line = 62:10]
  store i8 %V, i8* %out.addr.12, align 1, !dbg !226 ; [debug line = 62:10]
  %rend3 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str2, i32 0, i32 0), i32 %rbegin2) nounwind, !dbg !227 ; [#uses=0 type=i32] [debug line = 63:7]
...
; <label>:5                                       ; preds = %3
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str1, i32 0, i32 0), i32 %rbegin) nounwind, !dbg !230 ; [#uses=0 type=i32] [debug line = 64:4]
