...
architecture behav of yuv_filter is 
    ...
    "yuv_filter,hls_ip_2017_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010clg400-1,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.450000,HLS_SYN_LAT=784418,HLS_SYN_TPT=784410,HLS_SYN_MEM=0,HLS_SYN_DSP=11,HLS_SYN_FF=2217,HLS_SYN_LUT=1778}";
    ...
    component start_for_yuv_scajbC IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_yuv2rgbkbM IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    start_for_yuv_scajbC_U : component start_for_yuv_scajbC
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_yuv2rgbkbM_U : component start_for_yuv2rgbkbM
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
