...
HD_PWD='C:/Users/User/Desktop/UNI/EmbeddedRealTimeSystem/Assignment2/HLS_labs/lab2/yuv_filter.prj/solution3/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log yuv_filter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source yuv_filter.tcl -notrace
