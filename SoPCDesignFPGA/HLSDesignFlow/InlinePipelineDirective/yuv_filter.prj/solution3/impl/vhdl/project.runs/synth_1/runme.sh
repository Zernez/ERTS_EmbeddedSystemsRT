...
HD_PWD='C:/Users/User/Desktop/UNI/EmbeddedRealTimeSystem/Assignment2/HLS_labs/lab2/yuv_filter.prj/solution3/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log yuv_filter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source yuv_filter.tcl
