...
#ifndef __yuv_filter_mac_mueOg__HH__
#define __yuv_filter_mac_mueOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(yuv_filter_mac_mueOg) {
    ...
    SC_CTOR(yuv_filter_mac_mueOg):  simcore_mac_2_U ("simcore_mac_2_U") {
