...
#ifndef __yuv_filter_mac_mudEe__HH__
#define __yuv_filter_mac_mudEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(yuv_filter_mac_mudEe) {
    ...
    SC_CTOR(yuv_filter_mac_mudEe):  simcore_mac_1_U ("simcore_mac_1_U") {
