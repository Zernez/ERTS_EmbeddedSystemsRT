...
yuv_filter::yuv_filter(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    start_for_yuv_scajbC_U = new start_for_yuv_scajbC("start_for_yuv_scajbC_U");
    start_for_yuv_scajbC_U->clk(ap_clk);
    start_for_yuv_scajbC_U->reset(ap_rst);
    start_for_yuv_scajbC_U->if_read_ce(ap_var_for_const0);
    start_for_yuv_scajbC_U->if_write_ce(ap_var_for_const0);
    start_for_yuv_scajbC_U->if_din(start_for_yuv_scale_U0_din);
    start_for_yuv_scajbC_U->if_full_n(start_for_yuv_scale_U0_full_n);
    start_for_yuv_scajbC_U->if_write(rgb2yuv11_U0_start_write);
    start_for_yuv_scajbC_U->if_dout(start_for_yuv_scale_U0_dout);
    start_for_yuv_scajbC_U->if_empty_n(start_for_yuv_scale_U0_empty_n);
    start_for_yuv_scajbC_U->if_read(yuv_scale_U0_ap_ready);
    start_for_yuv2rgbkbM_U = new start_for_yuv2rgbkbM("start_for_yuv2rgbkbM_U");
    start_for_yuv2rgbkbM_U->clk(ap_clk);
    start_for_yuv2rgbkbM_U->reset(ap_rst);
    start_for_yuv2rgbkbM_U->if_read_ce(ap_var_for_const0);
    start_for_yuv2rgbkbM_U->if_write_ce(ap_var_for_const0);
    start_for_yuv2rgbkbM_U->if_din(start_for_yuv2rgb_U0_din);
    start_for_yuv2rgbkbM_U->if_full_n(start_for_yuv2rgb_U0_full_n);
    start_for_yuv2rgbkbM_U->if_write(yuv_scale_U0_start_write);
    start_for_yuv2rgbkbM_U->if_dout(start_for_yuv2rgb_U0_dout);
    start_for_yuv2rgbkbM_U->if_empty_n(start_for_yuv2rgb_U0_empty_n);
    start_for_yuv2rgbkbM_U->if_read(yuv2rgb_U0_ap_ready);
...
yuv_filter::~yuv_filter() {
    ...
    delete start_for_yuv_scajbC_U;
    delete start_for_yuv2rgbkbM_U;
}
