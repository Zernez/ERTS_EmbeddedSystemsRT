...
#ifndef __yuv_filter_ama_adg8j__HH__
#define __yuv_filter_ama_adg8j__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(yuv_filter_ama_adg8j) {
    ...
    SC_CTOR(yuv_filter_ama_adg8j):  simcore_ama_0_U ("simcore_ama_0_U") {
