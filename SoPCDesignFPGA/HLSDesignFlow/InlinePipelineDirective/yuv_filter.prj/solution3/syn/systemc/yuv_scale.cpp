...
const sc_lv<4> yuv_scale::ap_ST_fsm_state7 = "1000";
...
yuv_scale::yuv_scale(sc_module_name name) : sc_module(name), mVcdFile(0) {
    yuv_filter_mul_mubkb_x_U22 = new yuv_filter_mul_mubkb<1,1,16,16,32>("yuv_filter_mul_mubkb_x_U22");
    yuv_filter_mul_mubkb_x_U22->din0(bound_fu_254_p0);
    yuv_filter_mul_mubkb_x_U22->din1(bound_fu_254_p1);
    yuv_filter_mul_mubkb_x_U22->dout(bound_fu_254_p2);
    ...
    sensitive << ( ap_reg_pp0_iter2_exitcond_flatten_reg_305 );
    ...
    SC_METHOD(thread_tmp_7_i_fu_203_p0);
    sensitive << ( ap_block_pp0_stage0_flag00000000 );
    sensitive << ( ap_enable_reg_pp0_iter2 );
    sensitive << ( tmp_7_i_fu_203_p00 );

    SC_METHOD(thread_tmp_7_i_fu_203_p00);
    sensitive << ( Y_reg_314 );

    SC_METHOD(thread_tmp_7_i_fu_203_p1);
    sensitive << ( ap_block_pp0_stage0_flag00000000 );
    sensitive << ( tmp_cast_i_reg_285 );
    sensitive << ( ap_enable_reg_pp0_iter2 );

    SC_METHOD(thread_tmp_7_i_fu_203_p2);
    sensitive << ( tmp_7_i_fu_203_p0 );
    sensitive << ( tmp_7_i_fu_203_p1 );

    SC_METHOD(thread_tmp_8_i_fu_219_p0);
    sensitive << ( ap_block_pp0_stage0_flag00000000 );
    sensitive << ( ap_enable_reg_pp0_iter2 );
    sensitive << ( tmp_8_i_fu_219_p00 );

    SC_METHOD(thread_tmp_8_i_fu_219_p00);
    sensitive << ( V_reg_324 );

    SC_METHOD(thread_tmp_8_i_fu_219_p1);
    sensitive << ( ap_block_pp0_stage0_flag00000000 );
    sensitive << ( tmp_2_cast_i_reg_295 );
    sensitive << ( ap_enable_reg_pp0_iter2 );

    SC_METHOD(thread_tmp_8_i_fu_219_p2);
    sensitive << ( tmp_8_i_fu_219_p0 );
    sensitive << ( tmp_8_i_fu_219_p1 );

    SC_METHOD(thread_tmp_cast_i_fu_174_p1);
    sensitive << ( Y_scale_read_reg_260 );

    SC_METHOD(thread_tmp_i_fu_211_p0);
    sensitive << ( ap_block_pp0_stage0_flag00000000 );
    sensitive << ( ap_enable_reg_pp0_iter2 );
    sensitive << ( tmp_i_fu_211_p00 );

    SC_METHOD(thread_tmp_i_fu_211_p00);
    sensitive << ( U_reg_319 );

    SC_METHOD(thread_tmp_i_fu_211_p1);
    sensitive << ( ap_block_pp0_stage0_flag00000000 );
    sensitive << ( tmp_1_cast_i_reg_290 );
    sensitive << ( ap_enable_reg_pp0_iter2 );

    SC_METHOD(thread_tmp_i_fu_211_p2);
    sensitive << ( tmp_i_fu_211_p0 );
    sensitive << ( tmp_i_fu_211_p1 );
    ...
    sc_trace(mVcdFile, tmp_10_i_reg_329, "tmp_10_i_reg_329");
    sc_trace(mVcdFile, tmp_11_i_reg_334, "tmp_11_i_reg_334");
    sc_trace(mVcdFile, tmp_12_i_reg_339, "tmp_12_i_reg_339");
    ...
    sc_trace(mVcdFile, tmp_7_i_fu_203_p0, "tmp_7_i_fu_203_p0");
    sc_trace(mVcdFile, tmp_7_i_fu_203_p1, "tmp_7_i_fu_203_p1");
    sc_trace(mVcdFile, tmp_i_fu_211_p0, "tmp_i_fu_211_p0");
    sc_trace(mVcdFile, tmp_i_fu_211_p1, "tmp_i_fu_211_p1");
    sc_trace(mVcdFile, tmp_8_i_fu_219_p0, "tmp_8_i_fu_219_p0");
    sc_trace(mVcdFile, tmp_8_i_fu_219_p1, "tmp_8_i_fu_219_p1");
    sc_trace(mVcdFile, tmp_7_i_fu_203_p2, "tmp_7_i_fu_203_p2");
    sc_trace(mVcdFile, tmp_i_fu_211_p2, "tmp_i_fu_211_p2");
    sc_trace(mVcdFile, tmp_8_i_fu_219_p2, "tmp_8_i_fu_219_p2");
    ...
    sc_trace(mVcdFile, tmp_7_i_fu_203_p00, "tmp_7_i_fu_203_p00");
    sc_trace(mVcdFile, tmp_8_i_fu_219_p00, "tmp_8_i_fu_219_p00");
    sc_trace(mVcdFile, tmp_i_fu_211_p00, "tmp_i_fu_211_p00");
#endif
...
yuv_scale::~yuv_scale() {
    ...
    delete yuv_filter_mul_mubkb_x_U22;
}
...
void yuv_scale::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_block_pp0_stage0_flag00011001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_0, ap_reg_pp0_iter1_exitcond_flatten_reg_305.read()))) {
        tmp_10_i_reg_329 = tmp_7_i_fu_203_p2.read().range(14, 7);
        tmp_11_i_reg_334 = tmp_i_fu_211_p2.read().range(14, 7);
        tmp_12_i_reg_339 = tmp_8_i_fu_219_p2.read().range(14, 7);
    }
}
...
void yuv_scale::thread_ap_CS_fsm_state7() {
...
void yuv_scale::thread_ap_block_pp0_stage0_flag00001001() {
  ...
  ((esl_seteq<1,1,1>(exitcond_flatten_reg_305.read(), ap_const_lv1_0) && 
   ...
   (esl_seteq<1,1,1>(exitcond_flatten_reg_305.read(), ap_const_lv1_0) && 
    esl_seteq<1,1,1>(ap_const_logic_0, in_channels_ch3_empty_n.read())))) || (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter3.read()) && 
  ((esl_seteq<1,1,1>(ap_const_lv1_0, ap_reg_pp0_iter2_exitcond_flatten_reg_305.read()) && 
...
void yuv_scale::thread_ap_block_state6_pp0_stage0_iter3() {
    ap_block_state6_pp0_stage0_iter3 = ((esl_seteq<1,1,1>(ap_const_lv1_0, ap_reg_pp0_iter2_exitcond_flatten_reg_305.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, out_channels_ch1_full_n.read())) || (esl_seteq<1,1,1>(ap_const_lv1_0, ap_reg_pp0_iter2_exitcond_flatten_reg_305.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, out_channels_ch2_full_n.read())) || (esl_seteq<1,1,1>(ap_const_lv1_0, ap_reg_pp0_iter2_exitcond_flatten_reg_305.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, out_channels_ch3_full_n.read())));
}
...
void yuv_scale::thread_out_channels_ch1_din() {
    out_channels_ch1_din = tmp_10_i_reg_329.read();
}
...
void yuv_scale::thread_out_channels_ch2_din() {
    out_channels_ch2_din = tmp_11_i_reg_334.read();
}
...
void yuv_scale::thread_out_channels_ch3_din() {
    out_channels_ch3_din = tmp_12_i_reg_339.read();
}
...
void yuv_scale::thread_tmp_7_i_fu_203_p0() {
    tmp_7_i_fu_203_p0 =  (sc_lv<8>) (tmp_7_i_fu_203_p00.read());
}

void yuv_scale::thread_tmp_7_i_fu_203_p00() {
    tmp_7_i_fu_203_p00 = esl_zext<15,8>(Y_reg_314.read());
}

void yuv_scale::thread_tmp_7_i_fu_203_p1() {
    tmp_7_i_fu_203_p1 =  (sc_lv<8>) (tmp_cast_i_reg_285.read());
}

void yuv_scale::thread_tmp_7_i_fu_203_p2() {
    tmp_7_i_fu_203_p2 = (!tmp_7_i_fu_203_p0.read().is_01() || !tmp_7_i_fu_203_p1.read().is_01())? sc_lv<15>(): sc_biguint<8>(tmp_7_i_fu_203_p0.read()) * sc_biguint<8>(tmp_7_i_fu_203_p1.read());
}

void yuv_scale::thread_tmp_8_i_fu_219_p0() {
    tmp_8_i_fu_219_p0 =  (sc_lv<8>) (tmp_8_i_fu_219_p00.read());
}

void yuv_scale::thread_tmp_8_i_fu_219_p00() {
    tmp_8_i_fu_219_p00 = esl_zext<15,8>(V_reg_324.read());
}

void yuv_scale::thread_tmp_8_i_fu_219_p1() {
    tmp_8_i_fu_219_p1 =  (sc_lv<8>) (tmp_2_cast_i_reg_295.read());
}

void yuv_scale::thread_tmp_8_i_fu_219_p2() {
    tmp_8_i_fu_219_p2 = (!tmp_8_i_fu_219_p0.read().is_01() || !tmp_8_i_fu_219_p1.read().is_01())? sc_lv<15>(): sc_biguint<8>(tmp_8_i_fu_219_p0.read()) * sc_biguint<8>(tmp_8_i_fu_219_p1.read());
}
...
void yuv_scale::thread_tmp_i_fu_211_p0() {
    tmp_i_fu_211_p0 =  (sc_lv<8>) (tmp_i_fu_211_p00.read());
}

void yuv_scale::thread_tmp_i_fu_211_p00() {
    tmp_i_fu_211_p00 = esl_zext<15,8>(U_reg_319.read());
}

void yuv_scale::thread_tmp_i_fu_211_p1() {
    tmp_i_fu_211_p1 =  (sc_lv<8>) (tmp_1_cast_i_reg_290.read());
}

void yuv_scale::thread_tmp_i_fu_211_p2() {
    tmp_i_fu_211_p2 = (!tmp_i_fu_211_p0.read().is_01() || !tmp_i_fu_211_p1.read().is_01())? sc_lv<15>(): sc_biguint<8>(tmp_i_fu_211_p0.read()) * sc_biguint<8>(tmp_i_fu_211_p1.read());
}
