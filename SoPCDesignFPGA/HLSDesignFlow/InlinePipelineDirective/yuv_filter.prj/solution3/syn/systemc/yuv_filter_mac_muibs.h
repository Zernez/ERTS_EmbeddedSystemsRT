...
#ifndef __yuv_filter_mac_muibs__HH__
#define __yuv_filter_mac_muibs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(yuv_filter_mac_muibs) {
    ...
    SC_CTOR(yuv_filter_mac_muibs):  simcore_mac_5_U ("simcore_mac_5_U") {
