...
#ifndef __yuv_filter_mac_mucud__HH__
#define __yuv_filter_mac_mucud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(yuv_filter_mac_mucud) {
    ...
    SC_CTOR(yuv_filter_mac_mucud):  simcore_mac_0_U ("simcore_mac_0_U") {
