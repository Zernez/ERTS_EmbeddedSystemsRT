...
set rc [catch {
  ...
  set_property webtalk.parent_dir {C:/git/erts/assignment_2/project_6 soft-vs-hard/exercise_6.cache/wt} [current_project]
  set_property parent.project_path {C:/git/erts/assignment_2/project_6 soft-vs-hard/exercise_6.xpr} [current_project]
  set_property ip_repo_paths {
  C:/git/erts/assignment_2/led_ip_1.0
  C:/git/erts/assignment_2/matrix_ip_1.0
} [current_project]
  set_property ip_output_repo {{C:/git/erts/assignment_2/project_6 soft-vs-hard/exercise_6.cache/ip}} [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  add_files -quiet {{C:/git/erts/assignment_2/project_6 soft-vs-hard/exercise_6.runs/synth_1/system_wrapper.dcp}}
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files {{C:/git/erts/assignment_2/project_6 soft-vs-hard/exercise_6.srcs/sources_1/bd/system/system.bd}}
  set_property is_locked true [get_files {{C:/git/erts/assignment_2/project_6 soft-vs-hard/exercise_6.srcs/sources_1/bd/system/system.bd}}]
  set_param project.isImplRun false
  read_xdc {{C:/git/erts/assignment_2/project_6 soft-vs-hard/exercise_6.srcs/constrs_1/imports/lab3/lab3_zybo.xdc}}
  set_param project.isImplRun true
