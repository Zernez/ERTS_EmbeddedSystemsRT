...
HD_PWD='C:/Users/User/Desktop/UNI/EmbeddedRealTimeSystem/Assignment2/exercises/exercise_8/advios.prj/solution1/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log advios.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source advios.tcl -notrace
