...
HD_PWD='C:/Users/User/Desktop/UNI/EmbeddedRealTimeSystem/Assignment2/exercises/exercise_8/advios.prj/solution1/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log advios.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source advios.tcl
