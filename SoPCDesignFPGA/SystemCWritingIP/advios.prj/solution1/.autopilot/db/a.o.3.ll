; ModuleID = 'C:/Users/User/Desktop/UNI/EmbeddedRealTimeSystem/Assignment2/exercises/exercise_8/advios.prj/solution1/.autopilot/db/a.o.3.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-f80:128:128-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S32"
target triple = "i686-pc-mingw32"

@ssdm_ins_advios_0_0_6 = constant i1 false        ; [#uses=0 type=i1*]
@ssdm_ins_advios_0_0_5 = constant i4 0            ; [#uses=0 type=i4*]
...
@ssdm_ins_advios_0_0_s = constant i1 false        ; [#uses=0 type=i1*]
@llvm_global_ctors_1 = appending global [1 x void ()*] [void ()* @_GLOBAL__I_a] ; [#uses=0 type=[1 x void ()*]*]
@llvm_global_ctors_0 = appending global [1 x i32] [i32 65535] ; [#uses=0 type=[1 x i32]*]
@advios_ssdm_thread_M_makePulse = external global i1 ; [#uses=1 type=i1*]
@advios_ssdm_thread_M_controlLeds = external global i1 ; [#uses=1 type=i1*]
@p_str9 = private unnamed_addr constant [15 x i8] c"__ssdm_reset__\00", align 1 ; [#uses=4 type=[15 x i8]*]
@p_str8 = private unnamed_addr constant [10 x i8] c"makePulse\00", align 1 ; [#uses=4 type=[10 x i8]*]
...
@p_str4 = private unnamed_addr constant [13 x i8] c"\22sc_uint<4>\22\00", align 1 ; [#uses=10 type=[13 x i8]*]
...
@p_str13 = private unnamed_addr constant [12 x i8] c"controlLeds\00", align 1 ; [#uses=4 type=[12 x i8]*]
@p_str12 = private unnamed_addr constant [6 x i8] c"count\00", align 1 ; [#uses=1 type=[6 x i8]*]
...
; [#uses=1]
define void @"advios::makePulse"(i1* %advios_clk_m_if_Val, i1* %advios_reset_m_if_Val, i4* %advios_ctrl_m_if_Val_V, i4* %advios_inSwitch_m_if_Val_V, i4* %advios_outLeds_m_if_Val_V, i4* %advios_count_Val_V) {
_ZN7_ap_sc_7sc_core4waitEi.exit3:
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %advios_clk_m_if_Val), !map !82
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %advios_reset_m_if_Val), !map !86
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %advios_ctrl_m_if_Val_V), !map !90
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %advios_inSwitch_m_if_Val_V), !map !94
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %advios_outLeds_m_if_Val_V), !map !98
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %advios_count_Val_V), !map !102
  call void @llvm.dbg.value(metadata !{i1* %advios_clk_m_if_Val}, i64 0, metadata !106), !dbg !1364 ; [debug line = 3:14] [debug variable = advios.clk.m_if.Val]
  call void @llvm.dbg.value(metadata !{i1* %advios_reset_m_if_Val}, i64 0, metadata !1365), !dbg !1364 ; [debug line = 3:14] [debug variable = advios.reset.m_if.Val]
  call void @llvm.dbg.value(metadata !{i4* %advios_ctrl_m_if_Val_V}, i64 0, metadata !1366), !dbg !1364 ; [debug line = 3:14] [debug variable = advios.ctrl.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %advios_inSwitch_m_if_Val_V}, i64 0, metadata !1382), !dbg !1364 ; [debug line = 3:14] [debug variable = advios.inSwitch.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %advios_outLeds_m_if_Val_V}, i64 0, metadata !1383), !dbg !1364 ; [debug line = 3:14] [debug variable = advios.outLeds.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %advios_count_Val_V}, i64 0, metadata !1394), !dbg !1364 ; [debug line = 3:14] [debug variable = advios.count.Val.V]
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %advios_clk_m_if_Val) nounwind, !dbg !1399 ; [debug line = 4:4]
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %advios_reset_m_if_Val) nounwind, !dbg !1401 ; [debug line = 5:3]
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [5 x i8]* @p_str5, i32 0, i32 0, i4* %advios_ctrl_m_if_Val_V) nounwind, !dbg !1402 ; [debug line = 6:3]
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [9 x i8]* @p_str6, i32 0, i32 0, i4* %advios_inSwitch_m_if_Val_V) nounwind, !dbg !1403 ; [debug line = 7:3]
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 1, [13 x i8]* @p_str4, [8 x i8]* @p_str7, i32 0, i32 0, i4* %advios_outLeds_m_if_Val_V) nounwind, !dbg !1404 ; [debug line = 8:3]
  call void (...)* @_ssdm_op_SpecProcessDef([7 x i8]* @p_str, i32 2, [10 x i8]* @p_str8) nounwind, !dbg !1405 ; [debug line = 9:3]
  %tmp = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str9), !dbg !1406 ; [#uses=1 type=i32] [debug line = 9:107]
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, [1 x i8]* @p_str10) nounwind, !dbg !1407 ; [debug line = 9:191]
  %p_ssdm_reset_v = call i32 (...)* @_ssdm_op_SpecStateBegin(i32 0, i32 0, i32 1) nounwind, !dbg !1408 ; [#uses=1 type=i32] [debug line = 9:241]
  call void @llvm.dbg.value(metadata !{i32 %p_ssdm_reset_v}, i64 0, metadata !1409), !dbg !1408 ; [debug line = 9:241] [debug variable = _ssdm_reset_v]
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %advios_count_Val_V, i4 0), !dbg !1410 ; [debug line = 365:13@56:100@207:13@5:1]
  %empty = call i32 (...)* @_ssdm_op_SpecStateEnd(i32 %p_ssdm_reset_v) nounwind, !dbg !1427 ; [#uses=0 type=i32] [debug line = 5:22]
  %empty_2 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str9, i32 %tmp), !dbg !1428 ; [#uses=0 type=i32] [debug line = 5:60]
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !1429 ; [debug line = 803:19@6:1]
  br label %0, !dbg !1436                         ; [debug line = 7:5]

; <label>:0                                       ; preds = %2, %_ZN7_ap_sc_7sc_core4waitEi.exit3
  %loop_begin = call i32 (...)* @_ssdm_op_SpecLoopBegin() nounwind ; [#uses=0 type=i32]
  br label %1, !dbg !1437                         ; [debug line = 11:18]

; <label>:1                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit, %0
  %i = phi i27 [ 0, %0 ], [ %i_1, %_ZN7_ap_sc_7sc_core4waitEi.exit ] ; [#uses=2 type=i27]
  %exitcond = icmp eq i27 %i, -34217728, !dbg !1437 ; [#uses=1 type=i1] [debug line = 11:18]
  %empty_3 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 100000000, i64 100000000, i64 100000000) ; [#uses=0 type=i32]
  %i_1 = add i27 %i, 1, !dbg !1440                ; [#uses=1 type=i27] [debug line = 11:60]
  br i1 %exitcond, label %2, label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !1437 ; [debug line = 11:18]

_ZN7_ap_sc_7sc_core4waitEi.exit:                  ; preds = %1
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !1441 ; [debug line = 803:19@11:67]
  call void @llvm.dbg.value(metadata !{i27 %i_1}, i64 0, metadata !1444), !dbg !1440 ; [debug line = 11:60] [debug variable = i]
  br label %1, !dbg !1440                         ; [debug line = 11:60]

; <label>:2                                       ; preds = %1
  %val_V = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %advios_count_Val_V), !dbg !1445 ; [#uses=1 type=i4] [debug line = 374:13@60:21@180:66@12:16]
  call void @llvm.dbg.value(metadata !{i4 %val_V}, i64 0, metadata !1458), !dbg !1445 ; [debug line = 374:13@60:21@180:66@12:16] [debug variable = val.V]
  %v_V = add i4 %val_V, 1, !dbg !1460             ; [#uses=1 type=i4] [debug line = 1441:95@284:113@284:115@206:21@12:16]
  call void @llvm.dbg.value(metadata !{i4 %v_V}, i64 0, metadata !1477), !dbg !1460 ; [debug line = 1441:95@284:113@284:115@206:21@12:16] [debug variable = v.V]
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %advios_count_Val_V, i4 %v_V), !dbg !1479 ; [debug line = 365:13@56:100@207:13@12:16]
  br label %0, !dbg !1482                         ; [debug line = 13:3]
}

; [#uses=1]
define void @"advios::controlLeds"(i1* %advios_clk_m_if_Val, i1* %advios_reset_m_if_Val, i4* %advios_ctrl_m_if_Val_V, i4* %advios_inSwitch_m_if_Val_V, i4* %advios_outLeds_m_if_Val_V, i4* %advios_count_Val_V) {
_ZN7_ap_sc_7sc_core4waitEi.exit:
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %advios_outLeds_m_if_Val_V), !map !98
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %advios_count_Val_V), !map !102
  call void @llvm.dbg.value(metadata !{i1* %advios_clk_m_if_Val}, i64 0, metadata !1483), !dbg !1486 ; [debug line = 16:14] [debug variable = advios.clk.m_if.Val]
  call void @llvm.dbg.value(metadata !{i1* %advios_reset_m_if_Val}, i64 0, metadata !1487), !dbg !1486 ; [debug line = 16:14] [debug variable = advios.reset.m_if.Val]
  call void @llvm.dbg.value(metadata !{i4* %advios_ctrl_m_if_Val_V}, i64 0, metadata !1488), !dbg !1486 ; [debug line = 16:14] [debug variable = advios.ctrl.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %advios_inSwitch_m_if_Val_V}, i64 0, metadata !1489), !dbg !1486 ; [debug line = 16:14] [debug variable = advios.inSwitch.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %advios_outLeds_m_if_Val_V}, i64 0, metadata !1490), !dbg !1486 ; [debug line = 16:14] [debug variable = advios.outLeds.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %advios_count_Val_V}, i64 0, metadata !1491), !dbg !1486 ; [debug line = 16:14] [debug variable = advios.count.Val.V]
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %advios_clk_m_if_Val) nounwind, !dbg !1492 ; [debug line = 17:4]
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %advios_reset_m_if_Val) nounwind, !dbg !1494 ; [debug line = 18:3]
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [5 x i8]* @p_str5, i32 0, i32 0, i4* %advios_ctrl_m_if_Val_V) nounwind, !dbg !1495 ; [debug line = 19:3]
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [9 x i8]* @p_str6, i32 0, i32 0, i4* %advios_inSwitch_m_if_Val_V) nounwind, !dbg !1496 ; [debug line = 20:3]
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 1, [13 x i8]* @p_str4, [8 x i8]* @p_str7, i32 0, i32 0, i4* %advios_outLeds_m_if_Val_V) nounwind, !dbg !1497 ; [debug line = 21:3]
  call void (...)* @_ssdm_op_SpecProcessDef([7 x i8]* @p_str, i32 2, [12 x i8]* @p_str13) nounwind, !dbg !1498 ; [debug line = 22:3]
  %tmp_2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str9), !dbg !1499 ; [#uses=1 type=i32] [debug line = 22:109]
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, [1 x i8]* @p_str10) nounwind, !dbg !1500 ; [debug line = 22:193]
  %p_ssdm_reset_v = call i32 (...)* @_ssdm_op_SpecStateBegin(i32 0, i32 0, i32 1) nounwind, !dbg !1501 ; [#uses=1 type=i32] [debug line = 22:243]
  call void @llvm.dbg.value(metadata !{i32 %p_ssdm_reset_v}, i64 0, metadata !1502), !dbg !1501 ; [debug line = 22:243] [debug variable = _ssdm_reset_v]
  call void (...)* @_ssdm_op_SpecIFCore(i4* %advios_ctrl_m_if_Val_V, [1 x i8]* @p_str10, [10 x i8]* @p_str14, [1 x i8]* @p_str10, i32 -1, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [17 x i8]* @p_str15), !dbg !1503 ; [debug line = 19:1]
  %empty = call i32 (...)* @_ssdm_op_SpecStateEnd(i32 %p_ssdm_reset_v) nounwind, !dbg !1504 ; [#uses=0 type=i32] [debug line = 19:92]
  %empty_4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str9, i32 %tmp_2), !dbg !1505 ; [#uses=0 type=i32] [debug line = 19:130]
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !1506 ; [debug line = 803:19@21:1]
  br label %0, !dbg !1508                         ; [debug line = 22:5]

; <label>:0                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit2, %_ZN7_ap_sc_7sc_core4waitEi.exit
  %val_V = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %advios_ctrl_m_if_Val_V), !dbg !1509 ; [#uses=1 type=i4] [debug line = 374:13@60:21@180:66@351:73@25:7]
  call void @llvm.dbg.value(metadata !{i4 %val_V}, i64 0, metadata !1458), !dbg !1509 ; [debug line = 374:13@60:21@180:66@351:73@25:7] [debug variable = val.V]
  %tmp = icmp eq i4 %val_V, 0, !dbg !1517         ; [#uses=1 type=i1] [debug line = 1979:9@3571:144@25:7]
  br i1 %tmp, label %1, label %5, !dbg !1515      ; [debug line = 25:7]

; <label>:1                                       ; preds = %0
  %val_V_1 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %advios_inSwitch_m_if_Val_V), !dbg !1781 ; [#uses=1 type=i4] [debug line = 374:13@60:21@180:66@351:73@27:8]
  call void @llvm.dbg.value(metadata !{i4 %val_V_1}, i64 0, metadata !1458), !dbg !1781 ; [debug line = 374:13@60:21@180:66@351:73@27:8] [debug variable = val.V]
  %tmp_1 = icmp eq i4 %val_V_1, -8, !dbg !1787    ; [#uses=1 type=i1] [debug line = 1979:9@3571:144@27:8]
  br i1 %tmp_1, label %2, label %3, !dbg !1785    ; [debug line = 27:8]

; <label>:2                                       ; preds = %1
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %advios_outLeds_m_if_Val_V, i4 0), !dbg !1789 ; [debug line = 365:13@56:100@207:13@427:73@27:34]
  br label %4, !dbg !1803                         ; [debug line = 27:57]

; <label>:3                                       ; preds = %1
  %val_V_5 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %advios_count_Val_V), !dbg !1804 ; [#uses=1 type=i4] [debug line = 374:13@60:21@180:66@28:25]
  call void @llvm.dbg.value(metadata !{i4 %val_V_5}, i64 0, metadata !1458), !dbg !1804 ; [debug line = 374:13@60:21@180:66@28:25] [debug variable = val.V]
  call void @llvm.dbg.value(metadata !{i4 %val_V_5}, i64 0, metadata !1809), !dbg !1811 ; [debug line = 206:21@427:73@28:25] [debug variable = v.V]
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %advios_outLeds_m_if_Val_V, i4 %val_V_5), !dbg !1813 ; [debug line = 365:13@56:100@207:13@427:73@28:25]
  br label %4

; <label>:4                                       ; preds = %3, %2
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2, !dbg !1816 ; [debug line = 29:3]

; <label>:5                                       ; preds = %0
  %val_V_6 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %advios_ctrl_m_if_Val_V), !dbg !1817 ; [#uses=1 type=i4] [debug line = 374:13@60:21@180:66@351:73@32:18]
  call void @llvm.dbg.value(metadata !{i4 %val_V_6}, i64 0, metadata !1458), !dbg !1817 ; [debug line = 374:13@60:21@180:66@351:73@32:18] [debug variable = val.V]
  %val_V_7 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %advios_inSwitch_m_if_Val_V), !dbg !1823 ; [#uses=1 type=i4] [debug line = 374:13@60:21@180:66@351:73@32:32]
  call void @llvm.dbg.value(metadata !{i4 %val_V_7}, i64 0, metadata !1458), !dbg !1823 ; [debug line = 374:13@60:21@180:66@351:73@32:32] [debug variable = val.V]
  call void @llvm.dbg.value(metadata !{i4 %val_V_6}, i64 0, metadata !1828), !dbg !1837 ; [debug line = 3374:0@32:32] [debug variable = lhs.V]
  call void @llvm.dbg.value(metadata !{i4 %val_V_7}, i64 0, metadata !1838), !dbg !1837 ; [debug line = 3374:0@32:32] [debug variable = rhs.V]
  %r_V = and i4 %val_V_7, %val_V_6, !dbg !1837    ; [#uses=1 type=i4] [debug line = 3374:0@32:32]
  call void @llvm.dbg.value(metadata !{i4 %r_V}, i64 0, metadata !1840), !dbg !1837 ; [debug line = 3374:0@32:32] [debug variable = r.V]
  call void @llvm.dbg.value(metadata !{i4 %r_V}, i64 0, metadata !1809), !dbg !1843 ; [debug line = 206:21@427:73@32:32] [debug variable = v.V]
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %advios_outLeds_m_if_Val_V, i4 %r_V), !dbg !1845 ; [debug line = 365:13@56:100@207:13@427:73@32:32]
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2

_ZN7_ap_sc_7sc_core4waitEi.exit2:                 ; preds = %5, %4
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !1848 ; [debug line = 803:19@34:3]
  br label %0, !dbg !1850                         ; [debug line = 35:2]
}

; [#uses=0]
define weak void @"advios::advios"(i1* %advios_clk_m_if_Val, i1* %advios_reset_m_if_Val, i4* %advios_ctrl_m_if_Val_V, i4* %advios_inSwitch_m_if_Val_V, i4* %advios_outLeds_m_if_Val_V, i4* %advios_count_Val_V) {
  call void (...)* @_ssdm_op_SpecIFCore(i4* %advios_ctrl_m_if_Val_V, [1 x i8]* @p_str10, [10 x i8]* @p_str14, [1 x i8]* @p_str10, i32 -1, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [17 x i8]* @p_str15)
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %advios_clk_m_if_Val), !map !82
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %advios_reset_m_if_Val), !map !86
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %advios_ctrl_m_if_Val_V), !map !90
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %advios_outLeds_m_if_Val_V), !map !98
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %advios_count_Val_V), !map !102
  call void @llvm.dbg.value(metadata !{i1* %advios_clk_m_if_Val}, i64 0, metadata !1851), !dbg !1854 ; [debug line = 16:3] [debug variable = advios.clk.m_if.Val]
  call void @llvm.dbg.value(metadata !{i1* %advios_reset_m_if_Val}, i64 0, metadata !1855), !dbg !1854 ; [debug line = 16:3] [debug variable = advios.reset.m_if.Val]
  call void @llvm.dbg.value(metadata !{i4* %advios_ctrl_m_if_Val_V}, i64 0, metadata !1856), !dbg !1854 ; [debug line = 16:3] [debug variable = advios.ctrl.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %advios_inSwitch_m_if_Val_V}, i64 0, metadata !1857), !dbg !1854 ; [debug line = 16:3] [debug variable = advios.inSwitch.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %advios_outLeds_m_if_Val_V}, i64 0, metadata !1858), !dbg !1854 ; [debug line = 16:3] [debug variable = advios.outLeds.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %advios_count_Val_V}, i64 0, metadata !1859), !dbg !1854 ; [debug line = 16:3] [debug variable = advios.count.Val.V]
  call void (...)* @_ssdm_op_SpecTopModule([7 x i8]* @p_str, [7 x i8]* @p_str) nounwind, !dbg !1860 ; [debug line = 19:5]
  %advios_ssdm_threa = load i1* @advios_ssdm_thread_M_makePulse, align 1, !dbg !1862 ; [#uses=1 type=i1] [debug line = 20:5]
  br i1 %advios_ssdm_threa, label %1, label %2, !dbg !1862 ; [debug line = 20:5]

; <label>:1                                       ; preds = %0
  call void @"advios::makePulse"(i1* %advios_clk_m_if_Val, i1* %advios_reset_m_if_Val, i4* %advios_ctrl_m_if_Val_V, i4* %advios_inSwitch_m_if_Val_V, i4* %advios_outLeds_m_if_Val_V, i4* %advios_count_Val_V), !dbg !1863 ; [debug line = 20:36]
  br label %UnifiedUnreachableBlock

; <label>:2                                       ; preds = %0
  call void (...)* @_ssdm_op_SpecProcessDecl([7 x i8]* @p_str, i32 2, [10 x i8]* @p_str8) nounwind, !dbg !1864 ; [debug line = 20:49]
  call void (...)* @_ssdm_op_SpecSensitive([10 x i8]* @p_str8, [4 x i8]* @p_str2, i1* %advios_clk_m_if_Val, i32 1) nounwind, !dbg !1865 ; [debug line = 21:5]
  call void (...)* @_ssdm_op_SpecSensitive([10 x i8]* @p_str8, [6 x i8]* @p_str3, i1* %advios_reset_m_if_Val, i32 3) nounwind, !dbg !1866 ; [debug line = 22:5]
  %advios_ssdm_threa_1 = load i1* @advios_ssdm_thread_M_controlLeds, align 1, !dbg !1867 ; [#uses=1 type=i1] [debug line = 23:5]
  br i1 %advios_ssdm_threa_1, label %3, label %4, !dbg !1867 ; [debug line = 23:5]

; <label>:3                                       ; preds = %2
  call void @"advios::controlLeds"(i1* %advios_clk_m_if_Val, i1* %advios_reset_m_if_Val, i4* %advios_ctrl_m_if_Val_V, i4* %advios_inSwitch_m_if_Val_V, i4* %advios_outLeds_m_if_Val_V, i4* %advios_count_Val_V), !dbg !1868 ; [debug line = 23:38]
  br label %UnifiedUnreachableBlock

; <label>:4                                       ; preds = %2
  call void (...)* @_ssdm_op_SpecProcessDecl([7 x i8]* @p_str, i32 2, [12 x i8]* @p_str13) nounwind, !dbg !1869 ; [debug line = 23:53]
  call void (...)* @_ssdm_op_SpecSensitive([12 x i8]* @p_str13, [4 x i8]* @p_str2, i1* %advios_clk_m_if_Val, i32 1) nounwind, !dbg !1870 ; [debug line = 24:5]
  call void (...)* @_ssdm_op_SpecSensitive([12 x i8]* @p_str13, [6 x i8]* @p_str3, i1* %advios_reset_m_if_Val, i32 3) nounwind, !dbg !1871 ; [debug line = 25:5]
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %advios_clk_m_if_Val) nounwind, !dbg !1872 ; [debug line = 26:5]
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %advios_reset_m_if_Val) nounwind, !dbg !1873 ; [debug line = 27:5]
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [5 x i8]* @p_str5, i32 0, i32 0, i4* %advios_ctrl_m_if_Val_V) nounwind, !dbg !1874 ; [debug line = 28:5]
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [9 x i8]* @p_str6, i32 0, i32 0, i4* %advios_inSwitch_m_if_Val_V) nounwind, !dbg !1875 ; [debug line = 29:5]
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 1, [13 x i8]* @p_str4, [8 x i8]* @p_str7, i32 0, i32 0, i4* %advios_outLeds_m_if_Val_V) nounwind, !dbg !1876 ; [debug line = 30:5]
  call void (...)* @_ssdm_op_SpecChannel([7 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [6 x i8]* @p_str12, i32 1, i32 0, i4* %advios_count_Val_V) nounwind, !dbg !1877 ; [debug line = 31:5]
  ret void, !dbg !1878                            ; [debug line = 21:1]
