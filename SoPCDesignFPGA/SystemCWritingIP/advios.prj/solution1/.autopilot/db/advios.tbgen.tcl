...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			{"Name" : "clk", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_advios_makePulse_fu_88", "Port" : "clk"},
					{"ID" : "1", "SubInstance" : "grp_advios_controlLeds_fu_72", "Port" : "clk"}]},
			{"Name" : "reset", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_advios_makePulse_fu_88", "Port" : "reset"},
					{"ID" : "1", "SubInstance" : "grp_advios_controlLeds_fu_72", "Port" : "reset"}]},
			{"Name" : "ctrl", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_advios_makePulse_fu_88", "Port" : "ctrl"},
					{"ID" : "1", "SubInstance" : "grp_advios_controlLeds_fu_72", "Port" : "ctrl"}]},
			{"Name" : "inSwitch", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_advios_makePulse_fu_88", "Port" : "inSwitch"},
					{"ID" : "1", "SubInstance" : "grp_advios_controlLeds_fu_72", "Port" : "inSwitch"}]},
			{"Name" : "outLeds", "Type" : "Vld", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_advios_makePulse_fu_88", "Port" : "outLeds"},
					{"ID" : "1", "SubInstance" : "grp_advios_controlLeds_fu_72", "Port" : "outLeds"}]},
			{"Name" : "count", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_advios_makePulse_fu_88", "Port" : "count"},
					{"ID" : "1", "SubInstance" : "grp_advios_controlLeds_fu_72", "Port" : "count"}]},
			{"Name" : "advios_ssdm_thread_M_makePulse", "Type" : "None", "Direction" : "I"},
			{"Name" : "advios_ssdm_thread_M_controlLeds", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_advios_controlLeds_fu_72", "Parent" : "0",
		"CDFG" : "advios_controlLeds",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "0", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_advios_makePulse_fu_88", "Parent" : "0",
...
set ArgLastReadFirstWriteLatency {
	advios {
		...
		advios_ssdm_thread_M_makePulse {Type I LastRead -1 FirstWrite -1}
		advios_ssdm_thread_M_controlLeds {Type I LastRead -1 FirstWrite -1}}
	advios_controlLeds {
		clk {Type I LastRead -1 FirstWrite -1}
		reset {Type I LastRead -1 FirstWrite -1}
		ctrl {Type I LastRead 3 FirstWrite -1}
		...
		count {Type I LastRead 2 FirstWrite -1}}
	advios_makePulse {
		clk {Type I LastRead -1 FirstWrite -1}
		reset {Type I LastRead -1 FirstWrite -1}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "0", "Max" : "100000005"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "100000006"}
]}
