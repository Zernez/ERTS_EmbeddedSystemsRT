...
HD_PWD='C:/Users/User/Desktop/UNI/EmbeddedRealTimeSystem/Assignment2/exercises/exercise_8/exercise_8.runs/system_advios_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_advios_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_advios_0_0.tcl
