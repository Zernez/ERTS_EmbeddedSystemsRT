...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../exercise_2.srcs/sources_1/bd/system/ipshared/7e3a/hdl" \
       +incdir+"$ref_dir/../../../../exercise_2.srcs/sources_1/bd/system/ipshared/2ad9/hdl" \
       +incdir+"$ref_dir/../../../../exercise_2.srcs/sources_1/bd/system/ipshared/39ca/hdl/verilog" \
       +incdir+"$ref_dir/../../../../exercise_2.srcs/sources_1/bd/system/ipshared/1d61/hdl" \
       +incdir+"../../../../exercise_2.srcs/sources_1/bd/system/ipshared/7e3a/hdl" \
       +incdir+"../../../../exercise_2.srcs/sources_1/bd/system/ipshared/2ad9/hdl" \
       +incdir+"../../../../exercise_2.srcs/sources_1/bd/system/ipshared/39ca/hdl/verilog" \
       +incdir+"../../../../exercise_2.srcs/sources_1/bd/system/ipshared/6eb1/hdl" \
       +incdir+"../../../../exercise_2.srcs/sources_1/bd/system/ipshared/1d61/hdl"
}
